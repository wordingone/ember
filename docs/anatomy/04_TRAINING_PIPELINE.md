...
`tools/ember-restart-3b/` (`docs/ember-restart-3b-governed-runner-v1.md`
...
- `disk_budget_runner.py` — wraps any command with a hard C:/B: drive write-budget preflight (see the CPU-only launch example in `docs/ember-restart-3b-governed-runner-v1.md`, which caps `--max-c-write-gib 0` for the canary preflight)
...
custody directory (`docs/ember-restart-3b-governed-runner-v1.md`'s
