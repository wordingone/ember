...
| 03 | MODEL_ARCHITECTURE | the c03 dense network + BitNet ternary twin (`scripts/timeshare_pretrain.py`, `scripts/ember_bitnet_core.py`) |
...
`docs/probe-authoring-contract.md` discloses that `test_c_anat.py`'s presence
