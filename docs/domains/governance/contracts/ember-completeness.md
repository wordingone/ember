...
| M16 | S5 | surpass receipts (both legs) | ember > E2B: ember-work + founder-likeness | verdict machine staged: src/ember/governance/scripts/fp33_surpass_verdict.py (A1..B4 conjunction, McNemar + paired-bootstrap 10k, selftest 17/17) + docs/domains/governance/research/fp33-surpass-verdict-gate.md; emits the surpass receipt on leg data | GATED:M15 |
...
| C-MANIFEST | S6 | Completeness manifest enumerates every planned piece | docs/domains/governance/contracts/ember-completeness.md rows cover every §4 goal condition (id+subgoal+AC+receipt+status); an absent piece is a gate violation (does-NOT-count) | src/ember/governance/scripts/ember_totality/receipts-totality/ember-totality-20260710T150632Z.json (C-MANIFEST row, evaluated by src/ember/governance/scripts/ember_totality/test_c_manifest.py) | DONE |
