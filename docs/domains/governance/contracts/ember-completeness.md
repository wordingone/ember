...
| M16 | S5 | surpass receipts (both legs) | ember > E2B: ember-work + founder-likeness | verdict machine staged: scripts/fp33_surpass_verdict.py (A1..B4 conjunction, McNemar + paired-bootstrap 10k, selftest 17/17) + docs/domains/governance/research/fp33-surpass-verdict-gate.md; emits the surpass receipt on leg data | GATED:M15 |
