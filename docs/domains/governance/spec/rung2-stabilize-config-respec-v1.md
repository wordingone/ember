...
#516 (serving topology), docs/domains/governance/spec/rung2-grow-spec-v1.md. Frozen per docs/domains/governance/ledgers/deviations.md discipline:
...
1. This file at docs/domains/governance/spec/rung2-stabilize-config-respec-v1.md, verbatim except the
