...
| --- | --- | --- | --- |
| `domains/runtime/runtime/ember-lab/src/main.rs` (`ember-lab.exe`, all subcommands) | itself IS the daemon/CLI authority | N/A -- this is the authority, not a consumer | -- |
