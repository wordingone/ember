...
*Companion formalism: `docs/domains/governance/archive/pre-restart/formalization-v0.md` §3, §7.*
...
- **Training worlds are selected by the §7 criterion** (floor-accessible,
  ...
  - **W-harness (NC-K):** ember's own organs as a world — test suites +
    invariant checks as verifier; the predecessor-CLI invariant map (in extraction
