...
No prior document in this repo names this design. `docs/domains/governance/contracts/ember-completeness.md`'s C-FED row
...
and byte-scanned at launch (`TOKEN-SHARDS-V0`, `docs/domains/governance/contracts/ember-completeness.md` M33/M34, the
