# the lead-issue trigger-readiness map (verdict side)

Est. 2026-06-13. The verdict-side June-22 audit: every open the lead-class issue,
...
This map exists because the eng-stop-gate (the lead-class) names the lowest open
issue each turn. The honest position it records: **all open the lead issues are
...
the lead scorer can advance further until its trigger receipt lands.
