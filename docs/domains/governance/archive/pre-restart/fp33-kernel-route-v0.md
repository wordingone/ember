...
machine; the wall is broken by building the kernel path ourselves. Owner: the lead
(kernel research lane, per the fp-33 amendment); the engineer runs scripts/probes/dispatches.
...
3. **Optimizer + launch overhead (11.3%)** — cuda-graph-step row; untouched
   ...
   DISCREPANCY RESOLVED (the engineer mail 14746): live 12c050e7 runs
...
docs/domains/governance/contracts/registry-dispatch-gate-spec-v0.md — one technique per arm, seeds
