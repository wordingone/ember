...
## Root cause (the engineer): allocator fragmentation, not compute
...
ESCALATE_TORCH_OR_TRADEOFF. That is the genuine the maintainer tradeoff (NOT premature —
...
quality edge thin/an agent-flagged at delta_T −0.746 vs 0.605 floor). Only the user
