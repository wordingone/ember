...
freeze-target-before-iterating). the engineer runs it (mail 15439–15442). Ember derives
...
## Loop-economics framing (an agent 15051 — additive, does not change the band)
...
GPU-hour than backprop — an agent's "verified signal per GPU-hour" objective, made
...
`docs/domains/governance/charter/citation-policy-search-to-ember.md`: header = source step0778/step0785;
