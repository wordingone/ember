...
- **Floor (the contract):** `docs/domains/governance/contracts/goal-mode-mechanism.md`, restated as the six frozen clauses
...
- **Executed:** `cd src/ember/infrastructure/tools/ember-cli/src && bun test core/goal-organ-floor-conformance-642.test.ts`
...
Paths in the table are relative to `src/ember/infrastructure/tools/ember-cli/src/`, matching the source files' own
citation convention.
...
The six clauses cover `docs/domains/governance/contracts/goal-mode-mechanism.md`'s "Selection and persistence" (clauses 1–2) and
...
1. **Retired the `GOAL.md §6` floor citation.** On current master, GOAL.md §6 is "Clean genesis and
   frozen-reference boundary" — unrelated to goal mode. `docs/domains/governance/contracts/goal-mode-mechanism.md` is the sole
...
`docs/domains/governance/contracts/goal-mode-mechanism.md` blob `69484c1f6904630b611162c9dda7f6898d0b886a`.
