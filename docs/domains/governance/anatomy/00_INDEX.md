...
| 09 | TOOLING_AND_CLI | `src/ember/infrastructure/tools/ember-cli/`, `src/ember/governance/scripts/ember_avir_cli_launch_entry.py` |
...
| 12 | COCKPIT_OBSERVATORY | `src/ember/infrastructure/tools/ember-cli/src/core/ember-world-state.ts`, `src/ember/governance/scripts/ember_cobs_capture.py` |
