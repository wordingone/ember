...
`docs/domains/governance/ledgers/hardest-problems-register-v1.md`'s H4 entry ("O6: verifier-free
...
`docs/domains/governance/ledgers/hardest-problems-register-v1.md`, not resolved by this doc set.
