...
*2026-06-10. Sources: the compiled technical report (an agent,
...
3. **Compaction robustness by files, not prompt tuning:** the durable-file
   discipline (STATE.md, receipts, GOAL.md, this docs/research/ tree) already
...
## Citation status (added per an agent checkpoint 14418, FLAG S2-A)

Exact sources for the "docs-verified" claims above:
- Compiled report: `<local-path>` (an agent, 2026-06-09).
