...
Wrappers refuse without `--the lead-gate-token`. Token for this round:
**`r2-prereg-20260611-the lead`** — valid ONLY after (a) this doc is merged,
...
- **2026-06-11 (pre-rerun, GRPO pool clarification — pinned BEFORE the
  ...
  (informational-only — an agent 14511; load-bearing fix = eng-39/#142).
...
- **2026-06-11 (arm certification status):** sft + control receipts
  ...
  executed data path — an agent 14508/14511); certified reruns dispatch
