...
| 7 | SDEK kernel | local: `an agent-index/sdek-research-handoff.md` (avir repo) | internal | local handoff doc; the draft's `github.com/anthropic-ai/ai-research-an agent` URL is not a real pin — **removed**. |
