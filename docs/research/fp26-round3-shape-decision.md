...
## Recommendation (the lead, receipt-derived; user may redirect)
...
## Monitor wording resolution (an agent 14589 — closes AC item 4)
...
*Owner: the lead (#166 / task #49). Status: FROZEN. Round-3 shape = (b)
