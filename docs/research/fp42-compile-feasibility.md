...
the engineer's receipt named two walls but did not compute whether breaking them clears §3.
...
Gate the compiled+fused solo re-bench verdict: when #373 + #329 land and the engineer
