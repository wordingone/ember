...
**Goal:** Build the zero-Claude-active Stage-1 first-words lane: curate existing B-MULTI-1 assets into local noun manifests, freeze heldout, and make the multimodal launch gate accept local image-path manifests.
