...
- **Status:** GREEN (2026-07-03 totality receipt). Owned cbase checkpoint `B:/M/ember/models/cbase-smoke-run/checkpoints/step-00000610` exists, hash-verified, grow-dryrun receipt `cbase-grow-dryrun-20260702T190532Z.json` passes (no invalid-token, four CHK clauses pass).
