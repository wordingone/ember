...
`manifests/ember-01-identity/consumer-census-v1.json` is generated from
...
python -B scripts/ember_01_identity/census_consumers.py --root . --output manifests/ember-01-identity/consumer-census-v1.json
