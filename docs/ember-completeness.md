...
| C4 | S2 | verified-episode ledger (L1) | episodes pass verifier; manifest sha-bound | MISSING — L1-episode-verification receipt to mint (an agent 14866) | PART |
...
| C34 | S6 | fail-closed launch-rail stack (#181/#183/#186/#190/#192) | gate enforces prereg premises + shards byte-scan + live interlock | v0-launch-gate-20260611T075419Z (live 7/7); per-issue receipt mapping MISSING (an agent R2) | PART |
