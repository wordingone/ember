...
| 16 | C52 scaffolding-off test spec freeze (pre-stage of the goal terminal clause) | docs/c52-scaffold-off-test-v1.md FROZEN: window bounds, scaffold-off attestations (founder-process + zero-cloud audit), scripted event injection reusing sp6b verb classes, 1 verified-gain micro-round via own-r1 receipt class, content-hash binding; jude adversarial pass before first run | Leo | C52 (GATED:C10,C13) |
