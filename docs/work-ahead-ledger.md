...
| 19 | n=400 round-1 eval battery prep (H2 visibility: 3.85pp MDE needs n=400; inventory the W-code battery, stage the manifest before round-1 is ever dispatchable) | manifest + sha pins + power-note; AC: battery n≥400, held-out split frozen | Leo stage / jude verify | H2 / #205 |
