...
| Browser/UI | `ServiceNow/BrowserGym` | `9e779f087de9a65668b6974d11f9ce9816026e96` | Source identity only; no local runtime or frozen MiniWoB task bundle is claimed | environment snapshot, frozen task bundle, browser action protocol, and a bounded receipt |
