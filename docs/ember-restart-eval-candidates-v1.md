...
| --- | --- | --- | --- | --- |
| Terminal | `harbor-framework/terminal-bench-2` | `2fd12b88aafdd04a52c298e3940bcb189f9766d6` | Source custody and strict freezer; current cache is 89/0/0 (records/digest-pinned images/offline-eligible tasks) | digest-pinned task images, `allow_internet=false`, and a bounded Harbor run receipt |
| Files | `SWE-bench/SWE-bench_Lite` | `69611d31007e1c6731db8bd5b5c3f2d33f5bab6e` | Source-only custody plus deterministic changed-file fixture; exact dataset license and offline repository sandbox are not proven | declared dataset license, frozen task release, offline repository sandbox, and checkpoint-generated patch/file predictions |
...
| Structured tools | `ShishirPatil/gorilla` (BFCL component) | `6ea57973c7a6097fd7c5915698c54c17c5b1b6c8` | Frozen static function-call tasks and deterministic preflight scorer; live dependency/tool network remains excluded | pinned local harness/dependency environment, checkpoint-generated tool calls, and a bounded runtime receipt |
