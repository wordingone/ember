...
**Repo pin:** `wordingone/ember @ 3d48d3870919bd04cec735f68d0fad45fcfae0b2`. Authority order: INVARIANT.md → GOAL.md → CONTINUITY.md / docs/guides/START-HERE.md → the closed-boundary research annex (`docs/research/`, pinned).
