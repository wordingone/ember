...
Amendments to this frozen specification require entries in `docs/domains/governance/ledgers/deviations.md` under the battery-14 section. The deviation rule is: only deviations from this freeze are documented in that file; the document itself is immutable except via that mechanism.
