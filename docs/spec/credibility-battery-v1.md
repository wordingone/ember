...
document lands verbatim as a standing registry. Read `docs/START-HERE.md` first if any term below
is unfamiliar.
...
- `receipts/cbase-grow-rung2-event-grow-rung2-20260708-real-b3.json` — walked field-by-field in
  `docs/START-HERE.md` §3. `d_comm = 0.156090`, `cos_alignment = 0.988060`, band `iii`.
...
verdicts from artifacts (this same PR's `docs/START-HERE.md` §3 is one worked example — a
...
this is the concrete instance of `docs/START-HERE.md` §5's "verify one claim yourself" recipe.
