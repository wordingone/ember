...
**Board receipt:** `ember-totality-20260710T010438Z` (ts `20260710T010438Z`).

**Counts:** 10-GREEN / 25-RED / 2-UNEVALUABLE / 3-AUDIT-OK / 0-AUDIT-INCIDENT / 0-AUDIT-PENDING-EPOCH (total 40 rows, 27.0% of state-conditions GREEN).
