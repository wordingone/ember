...
**Board receipt:** `ember-totality-20260708T034014Z` (ts `20260708T034014Z`).

**Counts:** 7-GREEN / 28-RED / 2-UNEVALUABLE / 0-AUDIT-OK / 0-AUDIT-INCIDENT / 3-AUDIT-PENDING-EPOCH (total 40 rows, 18.9% of state-conditions GREEN).
