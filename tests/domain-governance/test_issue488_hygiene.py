...
class Issue488HygieneTests(unittest.TestCase):
    ...
    def test_governance_contains_closed_hygiene_law(self):
        text = (REPO_ROOT / "docs/domains/governance/authority/GOVERNANCE.md").read_text(encoding="utf-8")
        for marker in (
    ...
    def test_producer_returns_closed_path_free_manifest(self):
        ...
        self.assertEqual(manifest["policy"]["canonical_carrier"], "docs/domains/governance/authority/GOVERNANCE.md")
    ...
    def test_checked_in_manifest_and_receipt_bind_full_cadence_policy(self):
        ...
        self.assertEqual(
            receipt["cleanup_scope"],
            {
                ...
                "canonical_carrier": "docs/domains/governance/authority/GOVERNANCE.md",
    ...
    def test_safe_cleanup_emits_path_free_before_after_receipt_and_rollback_data(self):
        ...
        self.assertEqual(result["cleanup_scope"]["canonical_carrier"], "docs/domains/governance/authority/GOVERNANCE.md")
