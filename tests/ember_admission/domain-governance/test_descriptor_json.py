...
"""Strict descriptor JSON parsing coverage."""
...
def test_duplicate_descriptor_key_is_terminal(tmp_path: Path) -> None:
    ...
    assert json.loads(result.stdout) == {"code": "descriptor.invalid", "ok": False}
