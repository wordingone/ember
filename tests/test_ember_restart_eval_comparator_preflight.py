...
def test_accepts_only_identically_pinned_target_and_comparator_preflights():
 with tempfile.TemporaryDirectory() as tmp:
  ...
  shared={"result":"PREFLIGHT_ONLY","admission":"NOT_ELIGIBLE","capability":"image","benchmark_id":"MMMU","benchmark_version":"v1","split_sha256":"a"*64,"harness_sha256":"b"*64,"protocol_sha256":"c"*64}
  target.write_text(json.dumps({**shared,"subject_checkpoint_sha256":"d"*64}));comparator.write_text(json.dumps({**shared,"subject_checkpoint_sha256":"e"*64}))
