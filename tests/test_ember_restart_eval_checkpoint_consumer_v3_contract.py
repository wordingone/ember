...
# disposition: ADAPTER
# issue1949 old_path: tests/test_ember_restart_eval_checkpoint_consumer_v3_contract.py
# issue1949 new_path: tests/domain-governance/test_ember_restart_eval_checkpoint_consumer_v3_contract.py
...
_issue1949_target = _issue1949_root.joinpath('tests', 'domain-governance', 'test_ember_restart_eval_checkpoint_consumer_v3_contract.py')
if not _issue1949_target.is_file():
    raise ImportError("ISSUE1949_ADAPTER_TARGET_MISSING:tests/domain-governance/test_ember_restart_eval_checkpoint_consumer_v3_contract.py")
_issue1949_name = "_ember_issue1949_0130d3c33c92ac7f"
...
if _issue1949_spec is None or _issue1949_spec.loader is None:
    raise ImportError("ISSUE1949_ADAPTER_SPEC_INVALID:tests/domain-governance/test_ember_restart_eval_checkpoint_consumer_v3_contract.py")
