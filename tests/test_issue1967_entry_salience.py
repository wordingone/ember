...
INSTALL_COMMAND = "python src/ember/infrastructure/tools/ember-restart-3b/python_environment.py install"
...
def assert_direct_install_route(text: str) -> None:
    ...
    assert normalized.index("docs/domains/governance/guides/START-HERE.md") < command_index
