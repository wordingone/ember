...
class Legacy77VerifierTests(unittest.TestCase):
    def packet(self):
        ...
        next(row for row in rows if row["issue_number"] == 764)["matching_pr_set"]=[{"pr_number":1511,"url":"https://github.com/wordingone/ember/pull/1511","head":"07e2e43e44fbdefd1d19e10a56429b2f597559bf","base":"d648d7f9f692134bf51478d3303267666b04e342"}]
