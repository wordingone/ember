...
def _event(
    *,
    ...
    stack: tuple[str, ...] = ("src/ember/model/ember_v0_model.py:41",),
        ...
        "events": [
            {
                ...
                "source_stack": ["src/ember/model/ember_v0_model.py:41"],
            },
            {
                "ancestry_depth": 1,
                "cpu_parent_id": 7,
...
def test_issue2024_ledger_inherits_source_stack_from_cpu_parent_for_device_event() -> None:
    ledger = subject.build_issue2024_event_ledger(
        [_event(stack=(), parent_stack=("src/ember/model/ember_v0_model.py:99",))],
        declared_self_device_time_total_us="10.000001",
    )
    assert ledger["events"][0]["source_stack"] == [
        "src/ember/model/ember_v0_model.py:99"
    ]
