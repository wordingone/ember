...
# applies, mirrored from src/ember/infrastructure/tools/ember-restart-3b/run_vertical_slice.py
...
def test_production_source_binds_verifier_to_live_capture() -> None:
    ...
    source = (
        root / "src" / "ember" / "infrastructure" / "tools"
        / "ember-restart-3b" / "run_vertical_slice.py"
