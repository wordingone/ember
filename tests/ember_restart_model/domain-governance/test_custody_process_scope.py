...
reinvented:
  ...
  - fburst-proclock/src/ember/infrastructure/tools/ember-restart-3b/zzz_proc_probe.py + zzz_worker.py
    -> test_exactly_once_across_processes, test_kill_mid_write_converges
  - fburst-unlinkwin/src/ember/infrastructure/tools/ember-restart-3b/zzz_unlink_probe.py +
...
TOOLS_DIR = ROOT / "src" / "ember" / "infrastructure" / "tools" / "ember-restart-3b"
