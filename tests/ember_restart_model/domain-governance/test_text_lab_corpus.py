...
class TextLabCorpusTests(unittest.TestCase):
    ...
    def test_checked_in_authority_returns_terminal_unresolved_after_portable_structural_validation(self):
        ...
        self.assertEqual(admitted["admitted_row_count"], 30)
        self.assertEqual(admitted["run_manifest_row_count"], 30)
        self.assertEqual(
            admitted["admitted_row_set_sha256"],
            "f29eb6e65c59de5f1d767ecdc26d7488fbfe251ffcf6c8a04f4ce3e859ee82c7",
        )
