...
MINTER = ROOT / "tools" / "ember-restart-3b" / "mint_issue1719_tranche_admission.py"
EXISTING_MINTER_TEST = ROOT / "tests" / "ember_restart_model" / "test_mint_issue1719_tranche_admission.py"
