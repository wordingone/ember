...
SCRIPT = ROOT / "src" / "ember" / "infrastructure" / "tools" / "ember-restart-3b" / "mint_github_license_partition.py"
K_REFUSAL_SCRIPT = ROOT / "src" / "ember" / "infrastructure" / "tools" / "ember-restart-3b" / "mint_github_partition_refusal.py"
