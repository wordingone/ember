...
def test_arc_and_mmlu_protocols_pin_their_deterministic_scorer_bytes():
 expected={'ember-restart-arc-challenge-protocol-v1.json':'scripts/ember_restart_eval_arc_challenge.py','ember-restart-mmlu-pro-protocol-v1.json':'scripts/ember_restart_eval_mmlu_pro_score.py'}
