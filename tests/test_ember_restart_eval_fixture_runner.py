...
def test_embedded_actual_values_are_labeled_non_admissible_selftest():
    with tempfile.TemporaryDirectory() as tmp:
        ...
        assert json.loads(output.read_text()) == {"result": "SELFTEST", "admission": "NOT_ELIGIBLE", "fixture_sha256": hashlib.sha256(fixture.read_bytes()).hexdigest(), "correct": 5, "rows": [{"id": c, "capability": c, "correct": True} for c in ("text", "image", "audio", "reasoning", "tool")], "total": 5}
