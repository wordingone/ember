...
def test_execute_shared_route_loads_only_shared_state(tmp_path, monkeypatch):
    ...
    checkpoint = {"active_expert_ids": ["shared"], "model_config": {}, "model_config_sha256": "a" * 64, "tokenizer_sha256": "b" * 64, "checkpoint_manifest_sha256": "0" * 64, "counter_sha256": "c" * 64, "trusted_verifier_registry_sha256": "d" * 64, "parameter_receipt_sha256": "e" * 64, "required_shards": {"shared.pt": shared_sha256}}
