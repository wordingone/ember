...
def test_spider_requires_canonical_tool_predictions():
    with tempfile.TemporaryDirectory() as tmp:
        ...
        predictions.write_text(json.dumps({"schema_version": "ember-owned-predictions-v1", "claim_status": "NON_ADMISSIBLE_RAW_PREDICTIONS", "checkpoint_manifest_sha256": "bf20f05018991eb611b0623edd50a00ec30639da2f8ccae646f6962f152a2a2b", "model_config_sha256": "559959894dc603f9fbccbb091b3a084fef23b58d29add05efd14799a9a298ae0", "tokenizer_sha256": "c" * 64, "inference_implementation_sha256": "d" * 64, "benchmark": {"id": "spider", "version": "b7b5b8c890cd30e35427348bb9eb8c6d1350ca7c", "capability": "tool", "split_sha256": digest(gold), "protocol_sha256": json.loads(custody.read_text(encoding="utf-8"))["protocol_sha256"]}, "decoding": {"strategy": "GREEDY_AUTOREGRESSIVE", "teacher_forcing": False, "max_new_tokens": 1, "temperature": 0, "top_p": 1, "stop_token_ids": [2]}, "rows": [{"id": "0", "input_sha256": "f" * 64, "generated_token_ids": [2], "stop_reason": "eos", "output": {"kind": "sql", "sql": "select 1"}}]}), encoding="utf-8")
        ...
        assert payload["checkpoint_manifest_sha256"] == "bf20f05018991eb611b0623edd50a00ec30639da2f8ccae646f6962f152a2a2b"
...
def test_spider_rejects_altered_protocol_identity(tmp_path):
    ...
    envelope = {"schema_version": "ember-owned-predictions-v1", "claim_status": "NON_ADMISSIBLE_RAW_PREDICTIONS", "checkpoint_manifest_sha256": "bf20f05018991eb611b0623edd50a00ec30639da2f8ccae646f6962f152a2a2b", "model_config_sha256": "559959894dc603f9fbccbb091b3a084fef23b58d29add05efd14799a9a298ae0", "tokenizer_sha256": "c" * 64, "inference_implementation_sha256": "d" * 64, "benchmark": {"id": "spider", "version": module.SPIDER_VERSION, "capability": "tool", "split_sha256": "e" * 64, "protocol_sha256": "0" * 64}, "decoding": {"strategy": "GREEDY_AUTOREGRESSIVE", "teacher_forcing": False, "max_new_tokens": 1, "temperature": 0, "top_p": 1, "stop_token_ids": [2]}, "rows": [{"id": "0", "input_sha256": "f" * 64, "generated_token_ids": [2], "stop_reason": "eos", "output": {"kind": "sql", "sql": "select 1"}}]}
...
def test_spider_custody_requires_protocol_identity_for_canonical_scoring(tmp_path):
    ...
    manifest.write_text(json.dumps({"schema_version": "ember-restart-benchmark-custody-v1", "checkpoint_manifest_sha256": "bf20f05018991eb611b0623edd50a00ec30639da2f8ccae646f6962f152a2a2b", "model_config_sha256": "559959894dc603f9fbccbb091b3a084fef23b58d29add05efd14799a9a298ae0", "result": "PREFLIGHT_ONLY", "benchmark_id": "spider", "benchmark_version": module.SPIDER_VERSION, "gold_sha256": digest(gold), "tables_sha256": digest(tables), "database_tree_sha256": hashlib.sha256(b"db.sqlite\0db").hexdigest(), "evaluator_sha256": digest(source / "evaluation.py"), "source_tree_sha256": module.source_tree_sha256(source)}), encoding="utf-8")
...
def test_spider_rejects_well_formed_but_wrong_protocol_authority(tmp_path):
    ...
    database = tmp_path / "database"; database.mkdir(); (database / "db.sqlite").write_bytes(b"db")
    manifest = tmp_path / "custody.json"
    manifest.write_text(json.dumps({"schema_version": "ember-restart-benchmark-custody-v1", "checkpoint_manifest_sha256": "bf20f05018991eb611b0623edd50a00ec30639da2f8ccae646f6962f152a2a2b", "model_config_sha256": "559959894dc603f9fbccbb091b3a084fef23b58d29add05efd14799a9a298ae0", "result": "PREFLIGHT_ONLY", "benchmark_id": "spider", "benchmark_version": module.SPIDER_VERSION, "gold_sha256": digest(gold), "tables_sha256": digest(tables), "database_tree_sha256": module.database_tree_sha256(database), "evaluator_sha256": digest(source / "evaluation.py"), "source_tree_sha256": module.source_tree_sha256(source), "protocol_sha256": "0" * 64}), encoding="utf-8")
    with pytest.raises(ValueError, match="protocol"):
        module.verify_frozen_custody(manifest, source, gold, tables, database, include_protocol=True)
