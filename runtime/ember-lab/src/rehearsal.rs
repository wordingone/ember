        ...
        gates: vec![
            StrictGate {
                ...
                consumers: vec![
                    ...
                    "domains/runtime/runtime/ember-lab/src/lib.rs::dispatch_manifest_bytes".into(),
                ],
                binding: GateBinding::ContentHash,
            },
            StrictGate {
                name: "storage_reserves".into(),
                producer: "domains/runtime/runtime/ember-lab/src/lib.rs::DispatchStorageReserve".into(),
                consumers: vec![
                    "domains/runtime/runtime/ember-lab/src/lib.rs::validate_dispatch_manifest_snapshot_preconditions".into(),
                    "domains/runtime/runtime/ember-lab/src/lib.rs::dispatch_manifest_bytes_at_with_probes_and_host_inner".into(),
                ],
                binding: GateBinding::MeasuredValue,
            },
            StrictGate {
                name: "vram_reserve".into(),
                producer: "domains/runtime/runtime/ember-lab/src/lib.rs::available_free_vram_bytes".into(),
                consumers: vec!["domains/runtime/runtime/ember-lab/src/lib.rs::dispatch_manifest_bytes_at_with_probes_and_host_inner".into()],
                binding: GateBinding::MeasuredValue,
            },
            StrictGate {
                name: "host_commit_capacity".into(),
                producer: "domains/runtime/runtime/ember-lab/src/lib.rs::probe_host_commit_capacity".into(),
                consumers: vec!["domains/runtime/runtime/ember-lab/src/lib.rs::dispatch_manifest_bytes_at_with_probes_and_host_inner".into()],
                binding: GateBinding::MeasuredValue,
            },
            StrictGate {
                name: "preflight_receipt".into(),
                producer: "domains/runtime/runtime/ember-lab/src/lib.rs::atomic_replace".into(),
                consumers: vec!["domains/runtime/runtime/ember-lab/src/lib.rs::reconstruct_existing_dispatch".into()],
                binding: GateBinding::ContentHash,
            },
        ],
    }
