...
must_block "src/ember/infrastructure/tools/check_line_endings.py"
must_block "src/ember/infrastructure/tools/check_names_hashed.py"
must_block "src/ember/infrastructure/tools/check_no_temp.py"
must_block "src/ember/infrastructure/tools/repo-guard-denylist.sha256"
must_block "src/ember/infrastructure/tools/repo-guard-names-exclude.cfg"
must_block "src/ember/infrastructure/tools/no_temp_allowlist"
must_block "src/ember/governance/scripts/check_pr_authority_binding.py"
must_block "src/ember/infrastructure/tools/ember-cli/src/build-tools/lifecycle-smoke.test.ts"
must_block "src/ember/infrastructure/tools/ember-cli/src/build-tools/lifecycle-smoke-driver.ts"
...
must_allow "src/ember/infrastructure/tools/ember-cli/src/screens/repl.ts"
must_allow "src/ember/infrastructure/tools/ember-cli/src/ink/braille-canvas.ts"
must_allow "tools/ember-restart-3b/launch_packet.py"
must_allow "src/ember/infrastructure/tools/ember-restart-3b/launch_packet.py"
