...
# disposition: ADAPTER
# issue1949 old_path: scripts/ember_cbase_s6_acceptance.py
# issue1949 new_path: src/ember/governance/scripts/ember_cbase_s6_acceptance.py
...
_issue1949_target = _issue1949_root.joinpath('src', 'ember', 'governance', 'scripts', 'ember_cbase_s6_acceptance.py')
if not _issue1949_target.is_file():
    raise ImportError("ISSUE1949_ADAPTER_TARGET_MISSING:src/ember/governance/scripts/ember_cbase_s6_acceptance.py")
_issue1949_name = "_ember_issue1949_cf868e2067b90956"
...
if _issue1949_spec is None or _issue1949_spec.loader is None:
    raise ImportError("ISSUE1949_ADAPTER_SPEC_INVALID:src/ember/governance/scripts/ember_cbase_s6_acceptance.py")
