...
RECEIPTS: every mode writes one receipt via scripts/receipt_write.py::
...
Run:
  python scripts/ember_c14_owned_run.py --dry-run
  python scripts/ember_c14_owned_run.py --owned-smoke
  python scripts/ember_c14_owned_run.py --live      # refuses without
...
from ember_c14_contract_rig import (  # noqa: E402
    run_rig,
    print_report as _rig_print_report,
    RigResult,
    Corpus,
    Task,
)
...
def write_receipt(mode: str, payload: dict) -> Path:
    ...
    receipt = {
        ...
        "mode": mode,
        "script": "scripts/ember_c14_owned_run.py",
        **payload,
    }
