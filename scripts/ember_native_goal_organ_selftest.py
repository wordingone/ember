...
""",
            ...
            json.dumps(
                {
                    ...
                    "verdict": "THE_PREDECESSOR_CLI_FULL_PARITY_HARNESS_GATE_BLOCKED",
                    "surface_matrix": [
                        {
        ...
        assert "ember_gate_full_parity_harness.py" in receipt["bounded_action"]["compiled_action"]["command"]
