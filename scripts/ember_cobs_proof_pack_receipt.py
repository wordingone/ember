...
synthetic/hardcoded:
  ...
  2. Writes a structured JSON receipt under receipts/ember-c-obs-proof-pack/<ts>/receipt.json
     carrying:
       - emberworldstate_adapter: binds=true, sources=[docs/domains/governance/authority/GOAL.md, docs/domains/governance/ledgers/ember-debt-ledger.md,
...
def main() -> int:
    ...
    sources = [
        ...
        "docs/domains/governance/ledgers/ember-debt-ledger.md",
