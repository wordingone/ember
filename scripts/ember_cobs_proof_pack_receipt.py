...
synthetic/hardcoded:
  ...
  2. Writes a structured JSON receipt under receipts/ember-c-obs-proof-pack/<ts>/receipt.json
     carrying:
       - emberworldstate_adapter: binds=true, sources=[docs/authority/GOAL.md, docs/ledgers/ember-debt-ledger.md,
...
and everything they read (docs/authority/GOAL.md, docs/ledgers/ember-debt-ledger.md, the totality-board receipt) are
