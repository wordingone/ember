#!/usr/bin/env python3
"""Clean-room coordinator/agent backend gate for Ember's avir-cli parity harness.

This gate does not import avir-cli coordinator or agent code. It consumes the
...
REQUIRED_CAPABILITIES = {
    ...
    "skills_surface": ["skills/bundled/scheduleRemoteAgents", "skills/bundled/claudeApi", "skills/bundled/claudeApiContent"],
}
...
CLOUD_OR_UPSTREAM_COMPONENTS = {
    "AgentTool/built-in/claudeCodeGuideAgent",
    ...
    "skills/bundled/claudeApi",
    "skills/bundled/claudeApiContent",
}
            ...
            rows.append(
                {
                    ...
                    "has_brand_or_cloud_string": any(
                        ...
                        for token in ["claude", "claude.ai", "anthropic", "remote", "cloud", "subscription", "github app"]
                    ),
                }
            )
    return rows
