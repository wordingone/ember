...
# G1 eval, W-code r1, arm: control. Validation split (43 heldout, K3-clean),
...
sys.argv = ["w1_mbpp.py",
            ...
            "--temp", "0.8", "--seed", "16", "--tag", "g1-control",
            "--adapter", "/mnt/b/M/avir/leo/state/nc-ladder/adapters/r1w-q3-control"]
