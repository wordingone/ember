...
# disposition: ADAPTER
# issue1949 old_path: scripts/ember_growth_harness.py
# issue1949 new_path: src/ember/governance/scripts/ember_growth_harness.py
...
_issue1949_target = _issue1949_root.joinpath('src', 'ember', 'governance', 'scripts', 'ember_growth_harness.py')
if not _issue1949_target.is_file():
    raise ImportError("ISSUE1949_ADAPTER_TARGET_MISSING:src/ember/governance/scripts/ember_growth_harness.py")
_issue1949_name = "_ember_issue1949_4803e2cd359102ff"
...
if _issue1949_spec is None or _issue1949_spec.loader is None:
    raise ImportError("ISSUE1949_ADAPTER_SPEC_INVALID:src/ember/governance/scripts/ember_growth_harness.py")
