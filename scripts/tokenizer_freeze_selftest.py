...
# issue2015 exact-local-import-end:src/ember/governance/scripts/tokenizer_freeze.py  # noqa: E402
...
def main():
    ...
    # 3b. assembly-sha pin behavior (eng #160 AC-1, an agent 14560)
    with tempfile.TemporaryDirectory() as td:
    ...
    assert "no manifests/corpus/ mirrors" in src
