...
# issue2015 exact-local-import-end:src/ember/governance/scripts/receipt_write.py  # noqa: E402 (eng #107)
...
def main():
    ...
    in-receipt):
      ...
      - new_verified: round==2 rows in receipts/ledger/episodes.jsonl per task
    ...
    ledger = a.ledger or f"{NC}/receipts/ledger/episodes.jsonl"
    R = f"{NC}/receipts"
