...
Pre-registered in docs/delta-rule-diagnostic-prereg.md (frozen 2026-06-13, DT-1).
...
Citation lineage (docs/citation-policy-search-to-ember.md):
...
def _selftest() -> None:
    ...
    try:
        dummy_receipt = {
            ...
            "prereg": "docs/delta-rule-diagnostic-prereg.md",
            "model_size": "15M",
            "wall_clock_s": 120,
            "seeds": 2,
            "per_seed": [],
