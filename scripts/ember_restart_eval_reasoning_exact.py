...
"""Score checkpoint reasoning answers against a frozen local reference split."""
...
def main() -> int:
 ...
 payload={"criterion_id":"ember-3b-reasoning-capability-v1","criterion_result":"FAILED","metrics":{"exact_match":correct/len(references)},"sample_count":len(references),"upstream":"deterministic local frozen-answer scorer"}
