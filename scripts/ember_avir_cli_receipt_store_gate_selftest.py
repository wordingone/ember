#!/usr/bin/env python3
"""Selftest for the clean-room avir-cli receipt store gate."""
...
def main() -> int:
    import ember_avir_cli_receipt_store_gate as gate

    with tempfile.TemporaryDirectory(prefix="ember-avir-receipt-store-") as td:
        root = Path(td)
        repo = root / "repo"
        ...
        assert receipt["receipt_store"]["copies_avir_code"] is False
    ...
    print("EMBER_AVIR_CLI_RECEIPT_STORE_GATE_SELFTEST_PASS")
    return 0
