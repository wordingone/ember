...
# disposition: ADAPTER
# issue1949 old_path: scripts/density_sensitivity_probe.py
# issue1949 new_path: src/ember/governance/scripts/density_sensitivity_probe.py
...
_issue1949_target = _issue1949_root.joinpath('src', 'ember', 'governance', 'scripts', 'density_sensitivity_probe.py')
if not _issue1949_target.is_file():
    raise ImportError("ISSUE1949_ADAPTER_TARGET_MISSING:src/ember/governance/scripts/density_sensitivity_probe.py")
_issue1949_name = "_ember_issue1949_81e59c08e4ed5846"
...
if _issue1949_spec is None or _issue1949_spec.loader is None:
    raise ImportError("ISSUE1949_ADAPTER_SPEC_INVALID:src/ember/governance/scripts/density_sensitivity_probe.py")
