...
config/, or paper/ found in GOAL.md, docs/PROBLEMS.md, and every file in
...
SOURCE_FILES = ["GOAL.md", "docs/PROBLEMS.md"]
...
def run_selftest():
    ...
    with tempfile.TemporaryDirectory() as td:
        ...
        # GOAL.md's actual ASCII box-diagram shape: the fragment is followed
        ...
        # (k) guard 1 — real-corpus false positive (GOAL.md 2026-07-02): a
