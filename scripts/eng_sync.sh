...
# violation; bug surfaced by an agent checkpoint 14424 S1-C follow-up 2026-06-10).
...
# issue shows a manual button-close, closer=null). the lead-verified complete against
