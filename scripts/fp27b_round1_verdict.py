...
# issue2015 exact-local-import:src/ember/governance/scripts/fp27_round1_prereg.py
import importlib.util as _ember_bcbadd682d625873_importlib
import sys as _ember_bcbadd682d625873_sys
from pathlib import Path as _ember_bcbadd682d625873_Path
_ember_bcbadd682d625873_path = _ember_bcbadd682d625873_Path(__file__).resolve().parents[1].joinpath('src', 'ember', 'governance', 'scripts', 'fp27_round1_prereg.py')
if not _ember_bcbadd682d625873_path.is_file():
    raise ImportError('EXACT_LOCAL_IMPORT_TARGET_MISSING:src/ember/governance/scripts/fp27_round1_prereg.py')
_ember_bcbadd682d625873_aliases = ('_ember_issue2015_bcbadd682d625873', 'fp27_round1_prereg', 'scripts.fp27_round1_prereg')
_ember_bcbadd682d625873_existing = []
for _ember_bcbadd682d625873_alias in _ember_bcbadd682d625873_aliases:
    _ember_bcbadd682d625873_candidate = _ember_bcbadd682d625873_sys.modules.get(_ember_bcbadd682d625873_alias)
    if _ember_bcbadd682d625873_candidate is not None and all(_ember_bcbadd682d625873_candidate is not item for item in _ember_bcbadd682d625873_existing):
        _ember_bcbadd682d625873_existing.append(_ember_bcbadd682d625873_candidate)
if len(_ember_bcbadd682d625873_existing) > 1:
    raise ImportError('EXACT_LOCAL_IMPORT_IDENTITY_COLLISION:src/ember/governance/scripts/fp27_round1_prereg.py')
if _ember_bcbadd682d625873_existing:
    _ember_bcbadd682d625873_module = _ember_bcbadd682d625873_existing[0]
    _ember_bcbadd682d625873_observed = getattr(_ember_bcbadd682d625873_module, '__file__', None)
    if _ember_bcbadd682d625873_observed is None or _ember_bcbadd682d625873_Path(_ember_bcbadd682d625873_observed).resolve() != _ember_bcbadd682d625873_path:
        raise ImportError('EXACT_LOCAL_IMPORT_WRONG_TARGET:src/ember/governance/scripts/fp27_round1_prereg.py')
else:
    _ember_bcbadd682d625873_spec = _ember_bcbadd682d625873_importlib.spec_from_file_location('_ember_issue2015_bcbadd682d625873', _ember_bcbadd682d625873_path)
    if _ember_bcbadd682d625873_spec is None or _ember_bcbadd682d625873_spec.loader is None:
        raise ImportError('EXACT_LOCAL_IMPORT_SPEC_INVALID:src/ember/governance/scripts/fp27_round1_prereg.py')
    _ember_bcbadd682d625873_module = _ember_bcbadd682d625873_importlib.module_from_spec(_ember_bcbadd682d625873_spec)
    for _ember_bcbadd682d625873_alias in _ember_bcbadd682d625873_aliases:
        _ember_bcbadd682d625873_prior = _ember_bcbadd682d625873_sys.modules.get(_ember_bcbadd682d625873_alias)
        if _ember_bcbadd682d625873_prior is not None and _ember_bcbadd682d625873_prior is not _ember_bcbadd682d625873_module:
            raise ImportError('EXACT_LOCAL_IMPORT_ALIAS_COLLISION:src/ember/governance/scripts/fp27_round1_prereg.py')
        _ember_bcbadd682d625873_sys.modules[_ember_bcbadd682d625873_alias] = _ember_bcbadd682d625873_module
    try:
        _ember_bcbadd682d625873_spec.loader.exec_module(_ember_bcbadd682d625873_module)
    except BaseException:
        for _ember_bcbadd682d625873_alias in _ember_bcbadd682d625873_aliases:
            if _ember_bcbadd682d625873_sys.modules.get(_ember_bcbadd682d625873_alias) is _ember_bcbadd682d625873_module:
                _ember_bcbadd682d625873_sys.modules.pop(_ember_bcbadd682d625873_alias, None)
        raise
for _ember_bcbadd682d625873_alias in _ember_bcbadd682d625873_aliases:
    _ember_bcbadd682d625873_prior = _ember_bcbadd682d625873_sys.modules.get(_ember_bcbadd682d625873_alias)
    if _ember_bcbadd682d625873_prior is not None and _ember_bcbadd682d625873_prior is not _ember_bcbadd682d625873_module:
        raise ImportError('EXACT_LOCAL_IMPORT_ALIAS_COLLISION:src/ember/governance/scripts/fp27_round1_prereg.py')
    _ember_bcbadd682d625873_sys.modules[_ember_bcbadd682d625873_alias] = _ember_bcbadd682d625873_module
fp27 = _ember_bcbadd682d625873_module
# issue2015 exact-local-import-end:src/ember/governance/scripts/fp27_round1_prereg.py                      # noqa: E402
