...
# issue2015 exact-local-import:scripts/ember_01_custody/issue_census.py
...
_ember_70f78baaa2487a6e_path = _ember_70f78baaa2487a6e_Path(__file__).resolve().parents[2].joinpath('scripts', 'ember_01_custody', 'issue_census.py')
if not _ember_70f78baaa2487a6e_path.is_file():
    raise ImportError('EXACT_LOCAL_IMPORT_TARGET_MISSING:scripts/ember_01_custody/issue_census.py')
...
if len(_ember_70f78baaa2487a6e_existing) > 1:
    raise ImportError('EXACT_LOCAL_IMPORT_IDENTITY_COLLISION:scripts/ember_01_custody/issue_census.py')
if _ember_70f78baaa2487a6e_existing:
    ...
    if _ember_70f78baaa2487a6e_observed is None or _ember_70f78baaa2487a6e_Path(_ember_70f78baaa2487a6e_observed).resolve() != _ember_70f78baaa2487a6e_path:
        raise ImportError('EXACT_LOCAL_IMPORT_WRONG_TARGET:scripts/ember_01_custody/issue_census.py')
else:
    ...
    if _ember_70f78baaa2487a6e_spec is None or _ember_70f78baaa2487a6e_spec.loader is None:
        raise ImportError('EXACT_LOCAL_IMPORT_SPEC_INVALID:scripts/ember_01_custody/issue_census.py')
    ...
    for _ember_70f78baaa2487a6e_alias in _ember_70f78baaa2487a6e_aliases:
        ...
        if _ember_70f78baaa2487a6e_prior is not None and _ember_70f78baaa2487a6e_prior is not _ember_70f78baaa2487a6e_module:
            raise ImportError('EXACT_LOCAL_IMPORT_ALIAS_COLLISION:scripts/ember_01_custody/issue_census.py')
...
# issue2015 exact-local-import-end:scripts/ember_01_custody/issue_census.py
