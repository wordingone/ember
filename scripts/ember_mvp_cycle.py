...
def run_fixture_cycle(
    ...
    if state_substrate is not None and state_substrate_path is not None:
        ...
        cycle["evidence"]["state_substrate"] = {
            ...
            "gc_eligible": substrate_commit["gc_eligible"],
...
def validate_cycle_bundle(
    ...
    if promotion == "accepted":
        ...
        if state_commit.get("gc_eligible") is not False:
            errors.append("accepted promotion must not be gc_eligible")
    elif promotion == "rejected":
        if state_commit.get("gc_eligible") is not True:
            errors.append("rejected promotion must be gc_eligible after replay and rollback")
