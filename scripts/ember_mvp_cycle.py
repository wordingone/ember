...
This module is the local interface layer described in docs/domains/governance/archive/pre-restart/ember-mvp-v0.md.
...
def validate_cycle_bundle(
    ...
    """Validate cross-object MVP invariants from docs/domains/governance/archive/pre-restart/ember-mvp-v0.md."""
    errors: list[str] = []
