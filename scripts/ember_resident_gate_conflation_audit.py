...
def build_receipt(
    *,
    ...
    if full_parity_blocked:
        blocked_reasons.append("avir_cli_full_parity_harness_blocked")
    ...
    receipt = {
        ...
        "next_executable_command": (
            ...
            "python scripts\\ember_avir_cli_full_parity_harness_gate.py with the latest component receipts, "
