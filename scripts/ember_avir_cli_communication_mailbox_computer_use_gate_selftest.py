...
def main() -> int:
    import ember_avir_cli_communication_mailbox_computer_use_gate as gate

    with tempfile.TemporaryDirectory(prefix="ember-avir-communication-") as td:
        root = Path(td)
        repo = root / "repo"
        ...
        assert receipt["communication_mailbox_computer_use"]["copies_avir_code"] is False
    ...
    print("EMBER_AVIR_CLI_COMMUNICATION_MAILBOX_COMPUTER_USE_GATE_SELFTEST_PASS")
    return 0
