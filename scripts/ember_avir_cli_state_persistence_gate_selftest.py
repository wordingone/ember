#!/usr/bin/env python3
"""Selftest for the clean-room avir-cli state persistence gate."""
...
def main() -> int:
    import ember_avir_cli_state_persistence_gate as gate

    with tempfile.TemporaryDirectory(prefix="ember-avir-state-persistence-") as td:
        root = Path(td)
        repo = root / "repo"
        ...
        assert receipt["state_persistence"]["copies_avir_code"] is False
    ...
    print("EMBER_AVIR_CLI_STATE_PERSISTENCE_GATE_SELFTEST_PASS")
    return 0
