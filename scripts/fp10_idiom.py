...
# disposition: ADAPTER
# issue1949 old_path: scripts/fp10_idiom.py
# issue1949 new_path: src/ember/governance/scripts/fp10_idiom.py
...
_issue1949_target = _issue1949_root.joinpath('src', 'ember', 'governance', 'scripts', 'fp10_idiom.py')
if not _issue1949_target.is_file():
    raise ImportError("ISSUE1949_ADAPTER_TARGET_MISSING:src/ember/governance/scripts/fp10_idiom.py")
_issue1949_name = "_ember_issue1949_13efd4ac8e29bd83"
...
if _issue1949_spec is None or _issue1949_spec.loader is None:
    raise ImportError("ISSUE1949_ADAPTER_SPEC_INVALID:src/ember/governance/scripts/fp10_idiom.py")
