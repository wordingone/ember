...
DEFAULT_RECEIPTS = {
    ...
    "avir_full_parity": Path("receipts/ember-preloop-resident-gate/avir-cli-full-parity-harness-gate-20260622T152000Z-real-avir-observed.json"),
    "resident_training_gate": Path("receipts/ember-resident-training-gate/resident-training-gate-20260622T152500Z-real-avir-observed.json"),
    "bitnet_comparison": Path("receipts/ember-tiny-bitnet-comparison/20260622T152800Z-real-avir-observed/tiny_bitnet_comparison_receipt.json"),
    "d3_generalization": Path("receipts/ember-d3-native-loop/d3-prospective-task65-66-20260622T193000Z-real-avir-observed/d3-generalized-candidate-receipt.json"),
...
EXPECTED_VERDICTS = {
    ...
    "avir_full_parity": "AVIR_CLI_FULL_PARITY_HARNESS_GATE_PASS",
...
def build_audit(args: argparse.Namespace) -> dict[str, Any]:
    ...
    return {
        ...
        "goal_source_sha256": sha256_file(repo / "GOAL.md"),
        ...
        "valid_progress_preserved": [
            "resident gate and avir full-parity preconditions are preserved as gate evidence",
