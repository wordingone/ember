...
# disposition: ADAPTER
# issue1949 old_path: scripts/fp30_total_consistency.py
# issue1949 new_path: src/ember/governance/scripts/fp30_total_consistency.py
...
_issue1949_target = _issue1949_root.joinpath('src', 'ember', 'governance', 'scripts', 'fp30_total_consistency.py')
if not _issue1949_target.is_file():
    raise ImportError("ISSUE1949_ADAPTER_TARGET_MISSING:src/ember/governance/scripts/fp30_total_consistency.py")
_issue1949_name = "_ember_issue1949_609ef45c35872e8b"
...
if _issue1949_spec is None or _issue1949_spec.loader is None:
    raise ImportError("ISSUE1949_ADAPTER_SPEC_INVALID:src/ember/governance/scripts/fp30_total_consistency.py")
