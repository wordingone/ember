...
scripts/w1_collapse_control_run.py:run_phase2_live -- the SAME matched-recipe
...
Usage:
  CPU mechanics/schema smoke test (no GPU, no corpus, no decontam gate):
    python scripts/p1_envelope_sweep.py --point 3 --dry-run
  ...
  anything committed):
    EMBER_GATE_AUTHORIZED=1 python scripts/p1_envelope_sweep.py --point 3 \\
...
def run_point_live(args: argparse.Namespace, point_info: dict, ts: str,
    ...
    try:
        ...
        receipt = {
            ...
            "reused_launcher": ("scripts/w1_collapse_control_run.py:run_phase2_live "
