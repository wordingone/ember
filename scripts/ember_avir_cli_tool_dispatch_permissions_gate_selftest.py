#!/usr/bin/env python3
"""Selftest for the clean-room avir-cli tool dispatch permissions gate."""
...
def main() -> int:
    import ember_avir_cli_tool_dispatch_permissions_gate as gate

    with tempfile.TemporaryDirectory(prefix="ember-avir-tool-dispatch-") as td:
        root = Path(td)
        repo = root / "repo"
        ...
        assert receipt["tool_dispatch_permissions"]["copies_avir_code"] is False
    ...
    print("EMBER_AVIR_CLI_TOOL_DISPATCH_PERMISSIONS_GATE_SELFTEST_PASS")
    return 0
