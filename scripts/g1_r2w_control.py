...
# G1 eval, W-code r2, arm: control. Validation split (43 heldout), k=8
...
sys.argv = ["w1_mbpp.py",
            ...
            "--temp", "0.8", "--seed", "16", "--tag", "g1r2-control",
            "--adapter", "/mnt/b/M/avir/leo/state/nc-ladder/adapters/r2-q3-control"]
