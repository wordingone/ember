...
#   shows the commit that added it contains ONLY the receipt JSON (+ docs/STATE.md
...
GENERATOR_ABSENT_HISTORICAL_BASENAMES = [
    ...
    (re.compile(r"^pr1-review-verdict-.*\.json$"), "manually_authored",
     "evidence (c) manually-authored, cross-confirmed by (b): git log --follow shows commit "
     "bcdca5f adds only this receipt + STATE.md, no script; a hand-written PR review verdict."),
    (re.compile(r"^succession-trial-\d+-.*\.json$"), "manually_authored",
     "evidence (c) manually-authored, cross-confirmed by (b): git log --follow shows commit "
     "676fac9 adds only this receipt + CONTINUITY.md/README.md, no script; a hand-typed "
    ...
    (re.compile(r"^raw-corpus-materiality-.*\.json$"), "manually_authored",
     "evidence (c) manually-authored, cross-confirmed by (b): git log --follow shows commit "
     "defcc56 adds only STATE.md + docs + this receipt, no script."),
