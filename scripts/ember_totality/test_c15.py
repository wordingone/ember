...
C15 (from B:/M/avir/leo/state/ember-goal-leo.md, §4.2):
...
(python/python3 are not on the Windows PATH; the B: drive is /b/ under this WSL.)
"""
...
# ---------------------------------------------------------------------------
# Roots. The probe runs under WSL where the B: drive is mounted at /b/.
# Fall back to a couple of alternates so the probe is portable, but the
# canonical location is the kai-converge checkout.
# ---------------------------------------------------------------------------
