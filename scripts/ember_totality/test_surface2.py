...
tree. Root resolution: `EMBER_EXEC_ROOT` env var, default `B:/M/ember`
...
# EMBER_EXEC_ROOT env var can override. Default: B:/M/ember (frozen spec v1 convention)
DEFAULT_EXEC_ROOT = os.environ.get("EMBER_EXEC_ROOT", "B:/M/ember")
STALE_DAYS = 14
