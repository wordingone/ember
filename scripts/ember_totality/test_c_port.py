...
C-PORT — substrate portability: the organism survives its device
         (goal §4.2, ember-goal-leo.md L116; user reframe 2026-06-23).
...
inspecting state under kai-converge — never hardcoded. If the satisfying
...
Under WSL the B: drive is /mnt/b/ on this host (the sibling tests also try
/b/ for hosts with the bare-drive mount convention).
"""
