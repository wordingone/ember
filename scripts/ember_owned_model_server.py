...
# disposition: ADAPTER
# issue1949 old_path: scripts/ember_owned_model_server.py
# issue1949 new_path: src/ember/governance/scripts/ember_owned_model_server.py
...
_issue1949_target = _issue1949_root.joinpath('src', 'ember', 'governance', 'scripts', 'ember_owned_model_server.py')
if not _issue1949_target.is_file():
    raise ImportError("ISSUE1949_ADAPTER_TARGET_MISSING:src/ember/governance/scripts/ember_owned_model_server.py")
_issue1949_name = "_ember_issue1949_0199fdd881da6aa3"
...
if _issue1949_spec is None or _issue1949_spec.loader is None:
    raise ImportError("ISSUE1949_ADAPTER_SPEC_INVALID:src/ember/governance/scripts/ember_owned_model_server.py")
