...
# disposition: ADAPTER
# issue1949 old_path: scripts/energy_proxy_logger.py
# issue1949 new_path: src/ember/governance/scripts/energy_proxy_logger.py
...
_issue1949_target = _issue1949_root.joinpath('src', 'ember', 'governance', 'scripts', 'energy_proxy_logger.py')
if not _issue1949_target.is_file():
    raise ImportError("ISSUE1949_ADAPTER_TARGET_MISSING:src/ember/governance/scripts/energy_proxy_logger.py")
_issue1949_name = "_ember_issue1949_926b5002fa30f74f"
...
if _issue1949_spec is None or _issue1949_spec.loader is None:
    raise ImportError("ISSUE1949_ADAPTER_SPEC_INVALID:src/ember/governance/scripts/energy_proxy_logger.py")
