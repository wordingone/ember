...
import ember_avir_cli_function_slash_commands_gate as gate
...
| /chrome | 'Claude in Chrome (Beta) settings' | commands/chrome/index.ts:6 | **yes** - Claude |
...
"""
    ...
    print("EMBER_AVIR_CLI_FUNCTION_SLASH_COMMANDS_GATE_SELFTEST_PASS")
    return 0
