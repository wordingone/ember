...
def main():
 ...
 if a.capability in {'text','tool'} and score.get('predictions_sha256')!=predictions_sha256:p.error(f'{a.capability} score source hashes do not bind supplied evidence')
