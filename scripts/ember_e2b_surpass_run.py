...
RELATIONSHIP TO THE EXISTING RUNNER: scripts/ember_c_e2b_paired_run.py already
...
Reused VERBATIM from scripts/ember_c_e2b_paired_run.py (never duplicated —
...
BANKED COMMAND (fires only once a genuine C14 PASS receipt exists):
  ...
  EMBER_GATE_AUTHORIZED=1 python scripts/ember_e2b_surpass_run.py --live \
...
def cmd_dry_run(args: argparse.Namespace) -> int:
    ...
    receipt = {
        ...
        "script": "scripts/ember_e2b_surpass_run.py", "sha_convention": SHA_CONVENTION,
