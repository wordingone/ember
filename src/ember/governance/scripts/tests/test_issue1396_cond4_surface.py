...
def test_ci_enforces_transition_against_exact_pull_request_base() -> None:
    ...
    assert "src/ember/governance/scripts/tests/test_issue1396_cond4_surface.py" in workflow
    assert 'src/ember/governance/scripts/tests/test_verify_ember01_completion.py -k "cond4"' in workflow
