...
Builds two views that stamp every receipts/ledger/control-pool row with its
dedup-cluster membership:

  receipts/ledger/views/dedup-cluster.jsonl         (episodes)
  receipts/ledger/views/dedup-cluster-control.jsonl (control pool)
...
if _ember_2bafe3e3885447e6_existing:
    ...
    try:
        ...
        for _ember_2bafe3e3885447e6_alias in _ember_2bafe3e3885447e6_aliases:
            if _ember_2bafe3e3885447e6_sys.modules.get(_ember_2bafe3e3885447e6_alias) is _ember_2bafe3e3885447e6_module:
                _ember_2bafe3e3885447e6_sys.modules.pop(_ember_2bafe3e3885447e6_alias, None)
        raise
for _ember_2bafe3e3885447e6_alias in _ember_2bafe3e3885447e6_aliases:
    _ember_2bafe3e3885447e6_prior = _ember_2bafe3e3885447e6_sys.modules.get(_ember_2bafe3e3885447e6_alias)
    if _ember_2bafe3e3885447e6_prior is not None and _ember_2bafe3e3885447e6_prior is not _ember_2bafe3e3885447e6_module:
...
union_find_clusters = getattr(_ember_2bafe3e3885447e6_module, 'union_find_clusters')
NEAR_DUP_COS = getattr(_ember_2bafe3e3885447e6_module, 'NEAR_DUP_COS')
...
if _ember_5026f78346847442_existing:
    ...
    try:
        ...
        for _ember_5026f78346847442_alias in _ember_5026f78346847442_aliases:
            if _ember_5026f78346847442_sys.modules.get(_ember_5026f78346847442_alias) is _ember_5026f78346847442_module:
                _ember_5026f78346847442_sys.modules.pop(_ember_5026f78346847442_alias, None)
        raise
for _ember_5026f78346847442_alias in _ember_5026f78346847442_aliases:
    _ember_5026f78346847442_prior = _ember_5026f78346847442_sys.modules.get(_ember_5026f78346847442_alias)
    if _ember_5026f78346847442_prior is not None and _ember_5026f78346847442_prior is not _ember_5026f78346847442_module:
...
# issue2015 exact-local-import-end:src/ember/governance/scripts/fp10_idiom.py  # noqa: E402
