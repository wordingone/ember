...
Run:
    python src/ember/governance/scripts/test_ember_cbase_avir_data.py
"""
...
_ember_46d4d551e87bceea_path = _ember_46d4d551e87bceea_Path(__file__).resolve().parents[4].joinpath('src', 'ember', 'governance', 'scripts', 'ember_cbase_avir_data.py')
