    ...
    checks: list[tuple[str, list[str], list[str]]] = [
        (
            ...
            [
                ...
                "src/ember/governance/scripts/tests/test_registry_authority_gate.py",
        ...
        (
            "repo_guard_selftest",
            [py, "-B", "src/ember/infrastructure/tools/repo_guard_selftest.py"],
            ["python", "-B", "src/ember/infrastructure/tools/repo_guard_selftest.py"],
        ),
        (
        ...
        (
            ...
            [
                py,
                "-B",
                "src/ember/governance/scripts/check_pr_authority_binding.py",
                "--body-file",
