...
Usage:
  python src/ember/governance/scripts/w1_baseline_replay_closure.py --selftest
  python src/ember/governance/scripts/w1_baseline_replay_closure.py                 # preflight-only, CPU-safe
  EMBER_GATE_AUTHORIZED=1 EMBER_W1_MAINTAINER_WINDOW_CONFIRMED=1 \\
      python src/ember/governance/scripts/w1_baseline_replay_closure.py --live --device cuda \\
...
read_manifest = getattr(_ember_d9c5c82c124e1dc8_module, 'read_manifest')
