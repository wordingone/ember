...
SCOPE BOUNDARIES (disclosed, not silent gaps):
  ...
  * check_r1_e5 validates a section-5.4 frontier receipt (schema
    ...
    repo-document pins (prereg, admission config, docs/domains/governance/authority/INVARIANT.md, fixed-prior
...
Usage:
  python src/ember/governance/scripts/r1_exit_battery.py --selftest
  python src/ember/governance/scripts/r1_exit_battery.py --run-root <path> --exit e1 --out-dir receipts/ember-02-r1-exits
  python src/ember/governance/scripts/r1_exit_battery.py --run-root <path> --sibling-root <path> --exit e3 --out-dir ...
  python src/ember/governance/scripts/r1_exit_battery.py --run-root <path> --seed-root <path> --seed-root <path> --exit e7 --out-dir ...
  python src/ember/governance/scripts/r1_exit_battery.py --run-root <path> --sibling-root <path> --seed-root <path> --exit all --out-dir ...
"""
...
def _validate_frontier_content(
    ...
    load-bearing all apply here:
      * document binding -- every repo-document pin (prereg, admission
        ...
        registry, docs/domains/governance/authority/INVARIANT.md) must name THE pinned path, resolve inside
    ...
    if not isinstance(stamp, dict) or not _nonempty_str(stamp.get("invariant_md_sha256")):
        ...
        defects.append(
            "invariant_stamp.invariant_md_sha256 does not match the docs/domains/governance/authority/INVARIANT.md in force -- a "
    ...
    if not claimants:
        return {
            ...
            "detail": (
                ...
                "receipt; generate one with src/ember/governance/scripts/forecast_recalibration.py"
            ),
            "components": {"rung": rung, "candidate_validation": validations, "required_predicted_vs_measured": required},
...
def run_selftest() -> None:
    ...
    with tempfile.TemporaryDirectory(prefix="r1_exit_battery_selftest_") as tmp:
        ...
        def _e5_repo(name: str) -> Path:
            ...
            (repo / "docs/domains/governance/authority/INVARIANT.md").write_bytes(b"SELFTEST_FIXTURE invariant\n")
        ...
        def _e5_receipt(repo: Path, run: Path, manifest: dict[str, Any]) -> dict[str, Any]:
            ...
            return {
                ...
                "advantage_claims": [],
                "invariant_stamp": {"invariant_md_sha256": sha_of(repo / "docs/domains/governance/authority/INVARIANT.md")},
                "predecessor_receipt": {
        ...
        # docs/domains/governance/authority/INVARIANT.md drift after receipt assembly -> the stamp no longer names the invariant in force.
        invariant_bytes = (e5_repo / "docs/domains/governance/authority/INVARIANT.md").read_bytes()
        (e5_repo / "docs/domains/governance/authority/INVARIANT.md").write_bytes(b"SELFTEST_FIXTURE invariant CHANGED\n")
        _e5_defect(_e5_case(), "docs/domains/governance/authority/INVARIANT.md in force")
        (e5_repo / "docs/domains/governance/authority/INVARIANT.md").write_bytes(invariant_bytes)
