...
# issue2015 exact-local-import:src/ember/governance/scripts/density_ab_bench.py
...
if len(_ember_86fa83cbbef8e61b_existing) > 1:
    raise ImportError('EXACT_LOCAL_IMPORT_IDENTITY_COLLISION:src/ember/governance/scripts/density_ab_bench.py')
if _ember_86fa83cbbef8e61b_existing:
    ...
    if _ember_86fa83cbbef8e61b_observed is None or _ember_86fa83cbbef8e61b_Path(_ember_86fa83cbbef8e61b_observed).resolve() != _ember_86fa83cbbef8e61b_path:
        raise ImportError('EXACT_LOCAL_IMPORT_WRONG_TARGET:src/ember/governance/scripts/density_ab_bench.py')
else:
    ...
    if _ember_86fa83cbbef8e61b_spec is None or _ember_86fa83cbbef8e61b_spec.loader is None:
        raise ImportError('EXACT_LOCAL_IMPORT_SPEC_INVALID:src/ember/governance/scripts/density_ab_bench.py')
    ...
    for _ember_86fa83cbbef8e61b_alias in _ember_86fa83cbbef8e61b_aliases:
        ...
        if _ember_86fa83cbbef8e61b_prior is not None and _ember_86fa83cbbef8e61b_prior is not _ember_86fa83cbbef8e61b_module:
            raise ImportError('EXACT_LOCAL_IMPORT_ALIAS_COLLISION:src/ember/governance/scripts/density_ab_bench.py')
...
# issue2015 exact-local-import-end:src/ember/governance/scripts/density_ab_bench.py
main()
