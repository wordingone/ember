...
Usage:
    python src/ember/governance/scripts/build_claims_index.py [--receipts-dir PATH]
...
def render_claims_md(rows) -> str:
    ...
    lines = [
        "# Claims index",
        "",
        "Generated by `src/ember/governance/scripts/build_claims_index.py` from the `ticket` / `issue` / "
