...
"""Clean-room Ember/[REDACTED] resident launch entrypoint.
...
a machine-readable handshake. It is not a copy of [REDACTED]-cli's TypeScript entry.
"""
...
def build_handshake(repo: Path, argv: list[str]) -> dict[str, Any]:
    ...
    return {
        "launcher": "ember_avir_cleanroom_launch_entry",
        "repo": str(repo),
        "argv": argv,
        "bin_name": "[REDACTED]",
