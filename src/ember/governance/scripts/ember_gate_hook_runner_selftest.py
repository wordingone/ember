#!/usr/bin/env python3
"""Selftest for the clean-room the predecessor CLI hook runner gate."""
...
def main() -> int:
    import ember_gate_hook_runner as gate

    with tempfile.TemporaryDirectory(prefix="ember-gate-hook-runner-") as td:
        root = Path(td)
        repo = root / "repo"
        ...
        assert receipt["hook_runner"]["copies_reference_code"] is False
    ...
    print("EMBER_GATE_HOOK_RUNNER_SELFTEST_PASS")
    return 0
