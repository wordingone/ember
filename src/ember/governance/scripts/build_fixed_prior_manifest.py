...
INVENTORY: tuple[dict, ...] = (
    ...
    dict(category="training_loop", kind="file",
         path="src/ember/training/pretrain.py",
    ...
    dict(category="training_loop", kind="file",
         path="src/ember/infrastructure/tools/ember-restart-3b/launch_packet.py",
         provenance="Dispatch preflight producing the launch packet ember-cli gates on."),
    dict(category="training_loop", kind="file",
         path="src/ember/infrastructure/tools/ember-restart-3b/run_vertical_slice.py",
