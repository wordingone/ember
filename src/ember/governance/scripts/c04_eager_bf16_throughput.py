...
NOT a hand-rebuild:
  ...
  cfg      : ts.load_contract()                           # domains/model/configs/v0-pretrain-config.json
...
def _run_bench() -> dict:
    ...
    # issue2015 exact-local-import-end:src/ember/governance/scripts/timeshare_pretrain.py  # lazy: pulls torch; only on the GPU path
