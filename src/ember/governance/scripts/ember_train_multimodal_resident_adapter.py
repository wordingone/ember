...
This adapter imports `src/ember/governance/scripts/train_multimodal_v0.py`, runs its tiny multimodal
...
def run_adapter(out_dir: Path, tasks_path: Path) -> dict[str, Any]:
    ...
    root = repo_root()
    train_path = root / "src/ember/governance/scripts/train_multimodal_v0.py"
    floor_path = root / "docs/contracts/ember-floor-contract.md"
    nc2_path = root / "nc2-own-technique-contract.md"
    adapter_path = root / "src/ember/governance/scripts/ember_train_multimodal_resident_adapter.py"
    ...
    trace = {
        "ticket": TICKET + "-TRACE",
        "ts": ts(),
        "source": "src/ember/governance/scripts/train_multimodal_v0.py run_step plus verifier-conditioned resident policy update",
    ...
    harness = {
        ...
        "adapter_path": "src/ember/governance/scripts/ember_train_multimodal_resident_adapter.py",
    ...
    manifest = {
        ...
        "generated_by": "src/ember/governance/scripts/ember_train_multimodal_resident_adapter.py",
        ...
        "verifier_conditioned_training_command": (
            ...
            "# imports src/ember/governance/scripts/train_multimodal_v0.py, calls run_step, then updates resident torch policy from verifier rewards"
        ),
