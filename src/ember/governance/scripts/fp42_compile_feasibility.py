...
at eager. the engineer's receipt named TWO independent walls but did not compute their JOINT
...
This is a feasibility ESTIMATE that sets targets (an agent's compile target, the
