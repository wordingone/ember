...
"""conv_c03_muon_ns3.py — 60M-token convergence run, muon_ns3 variant.
...
Optimizer: Muon NS3 over 2D hidden weights + AdamW over embed/norm/head.
Seed: 42. Data order: deterministic (pure-function loader, sorted shards).

Loss log: models/conv-muon_ns3-seed42/loss_log.jsonl
Receipt:  receipts/conv-muon_ns3-<ts>.json

Marker: CONV_SEGMENT_DONE opt_variant=muon_ns3
