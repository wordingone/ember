...
(src/ember/governance/scripts/cpu_offload_adamw.py:vram_preflight) permit or refuse a launch,
...
_ember_af5148f80571f78d_path = _ember_af5148f80571f78d_Path(__file__).resolve().parent.joinpath('cpu_offload_adamw.py')
