...
`run_v0_segment()` (src/ember/governance/scripts/timeshare_pretrain.py) resolves two independent
...
Usage:
  python src/ember/governance/scripts/run_v0_segment_device_test.py
