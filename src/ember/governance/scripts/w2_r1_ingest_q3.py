...
# receipts/ledger/episodes.jsonl + fails -> control_pool.jsonl. CPU-only, seconds.
NC = "<local-path>"
...
runpy.run_path(f"{NC}/src/ember/governance/scripts/w2_ingest.py", run_name="__main__")
