...
def verify_at_boot(
    ...
    if manifest_bytes != baseline_bytes:
        ...
        raise SystemExit(
            ...
            "src/ember/governance/scripts/nck/invariants.py --update-manifest to re-pin."
        )
...
def write_manifest_and_baseline(
    ...
    payload = {
        ...
        "note": (
            ...
            "Do not edit manually; regenerate via src/ember/governance/scripts/nck/invariants.py --update-manifest."
        ),
