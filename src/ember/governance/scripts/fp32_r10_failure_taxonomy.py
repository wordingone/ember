...
SHA_CONVENTION = ("file shas = sha256 over the exact on-disk raw bytes, no "
                  "normalization")
STORE_REDACTED = "~/.predecessor-cli/train/jobs.json (WSL Ubuntu, auto-resolved)"
...
def resolve_store():
    ...
    pats = (os.environ.get("FP32_R10_STORE") or "",
            "//wsl.localhost/Ubuntu/home/*/.predecessor-cli/train/jobs.json",
            os.path.expanduser("~/.predecessor-cli/train/jobs.json"))
    for pat in pats:
