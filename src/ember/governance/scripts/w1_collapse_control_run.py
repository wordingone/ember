...
Usage (dry run, the only supported mode from this workstation):
  python src/ember/governance/scripts/w1_collapse_control_run.py --dry-run
  python src/ember/governance/scripts/w1_collapse_control_run.py --dry-run --out-dir scratch/w1-control/dry-run/custom

Real run (maintainer-window only, never executed here):
  EMBER_GATE_AUTHORIZED=1 python src/ember/governance/scripts/w1_collapse_control_run.py \
...
restore_rng = getattr(_ember_d9c5c82c124e1dc8_module, 'restore_rng')
pacing_snapshot = getattr(_ember_d9c5c82c124e1dc8_module, 'pacing_snapshot')
_pace_reset = getattr(_ember_d9c5c82c124e1dc8_module, '_pace_reset')
_pace_record = getattr(_ember_d9c5c82c124e1dc8_module, '_pace_record')
check_resume_integrity = getattr(_ember_d9c5c82c124e1dc8_module, 'check_resume_integrity')
FP19_PACE_S = getattr(_ember_d9c5c82c124e1dc8_module, 'FP19_PACE_S')
PRETRAIN_CONTRACT_PATH = getattr(_ember_d9c5c82c124e1dc8_module, 'CONTRACT_PATH')
build_split_optimizer = getattr(_ember_d9c5c82c124e1dc8_module, 'build_split_optimizer')
save_optimizers_state = getattr(_ember_d9c5c82c124e1dc8_module, 'save_optimizers_state')
...
def cosine_warmup_frac(step: int, total_steps: int, *,
    ...
    2026-07-08, docs/domains/governance/ledgers/deviations.md DEV-003): when given, OVERRIDES
...
def verify_shard_corpus(shard_dir: str,
    ...
    if _ember_b5d7f3622ea07abe_existing:
        ...
        try:
            ...
            for _ember_b5d7f3622ea07abe_alias in _ember_b5d7f3622ea07abe_aliases:
                if _ember_b5d7f3622ea07abe_sys.modules.get(_ember_b5d7f3622ea07abe_alias) is _ember_b5d7f3622ea07abe_module:
                    _ember_b5d7f3622ea07abe_sys.modules.pop(_ember_b5d7f3622ea07abe_alias, None)
            raise
    for _ember_b5d7f3622ea07abe_alias in _ember_b5d7f3622ea07abe_aliases:
        _ember_b5d7f3622ea07abe_prior = _ember_b5d7f3622ea07abe_sys.modules.get(_ember_b5d7f3622ea07abe_alias)
        if _ember_b5d7f3622ea07abe_prior is not None and _ember_b5d7f3622ea07abe_prior is not _ember_b5d7f3622ea07abe_module:
...
def wire_launch_gate_check(xs: list, ys: list, *, seq: int, receipt_path: str,
    ...
    """Literal integration of src/ember/governance/scripts/w2_heldout/launch_gate.py's
    ...
    _ember_010558b39c5df353_path = _ember_010558b39c5df353_Path(__file__).resolve().parents[4].joinpath('src', 'ember', 'governance', 'scripts', 'w2_heldout', 'launch_gate.py')
    ...
    _ember_010558b39c5df353_aliases = ('_ember_issue2015_010558b39c5df353', 'launch_gate', 'scripts.w2_heldout.launch_gate', 'w2_heldout.launch_gate')
    ...
    # issue2015 exact-local-import-end:src/ember/governance/scripts/w2_heldout/launch_gate.py
...
def run_phase2_live(cfg_real: dict, real_arch: dict, *, ceiling_steps: int,
    ...
    warmup_steps: optional, additive (issue #118 P1 envelope sweep,
    2026-07-08, docs/domains/governance/ledgers/deviations.md DEV-003) -- passed straight through to
...
def main_live(args: argparse.Namespace, ts: str, pricing_receipt: dict,
    ...
    if args.decontam_receipt:
        ...
        # Literal reuse of src/ember/governance/scripts/w2_heldout/launch_gate.py's assert_launch_
