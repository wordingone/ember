...
import ember_gate_uiux_repl_components as gate
...
| `DiagnosticsDisplay` | `ours` | components/DiagnosticsDisplay.tsx:17 | the predecessor CLI `/diag` command output renderer |
...
| `hooks/HooksConfigMenu` | `identical` | components/hooks/HooksConfigMenu.tsx:354 | Brand string: ask the assistant model. |
| `mcp/MCPSettings` | `identical` | components/mcp/MCPSettings.tsx:210 | Brand string: the model vendor |
...
"""
    ...
    print("EMBER_GATE_UIUX_REPL_COMPONENTS_SELFTEST_PASS")
    return 0
