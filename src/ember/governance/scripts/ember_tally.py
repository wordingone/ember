"""ember_tally.py — completeness tally over docs/domains/governance/contracts/ember-completeness.md (#337).
...
--run      : run on the real docs/domains/governance/contracts/ember-completeness.md (dry output).
...
def main():
    ...
    ap.add_argument("--run", action="store_true",
                    help="tally over real docs/domains/governance/contracts/ember-completeness.md (dry)")
