...
inspecting state under <external-state-root> - never hardcoded.
...
Under WSL the execution root is /mnt<local-mount-point>/ on this host (the <local-mount-point>/ form is a fallback).
"""
...
# --- Locate external state root robustly across WSL mount conventions ----------------
