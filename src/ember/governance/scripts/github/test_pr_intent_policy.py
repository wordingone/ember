...
from src.ember.governance.scripts.github.live_pr_policy import REQUIRED_SECTIONS, SNAPSHOT_FIELDS
from src.ember.governance.scripts.github.pr_intent_policy import (
    INTENT_FIELDS,
    _names,
...
def intent() -> dict[str, object]:
    return {
        ...
        "milestone": MILESTONE,
        "changed_files": ["src/ember/governance/scripts/github/pr_intent_policy.py"],
