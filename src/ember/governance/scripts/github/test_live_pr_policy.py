...
from src.ember.governance.scripts.github.live_pr_policy import (
...
def human_pr() -> dict[str, object]:
    return {
        ...
        "changed_files": [
            ...
            "src/ember/governance/scripts/github/live_pr_policy.py",
        ],
...
class LivePullRequestPolicyTests(unittest.TestCase):
    ...
    def test_dependabot_has_closed_narrow_schema(self) -> None:
        ...
        for mutation, expected in (
            ...
            ({"changed_files": ["src/ember/governance/scripts/github/policy.py"]}, "dependabot:path"),
