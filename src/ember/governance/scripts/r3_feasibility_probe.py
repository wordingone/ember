...
Fail-closed rails (issue #47 A3, verbatim):
  - governor fraction read from src/ember/governance/scripts/governor.py's standard config
...
# issue2015 exact-local-import-end:src/ember/governance/scripts/governor.py  # noqa: E402  (env_limits/preflight/device_capability -- never reimplemented)
...
# blocksize=64, ...) call (src/ember/governance/scripts/convert_nf4_prequant.py, verified by direct
