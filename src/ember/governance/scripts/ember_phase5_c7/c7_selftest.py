...
def assert_c7_deletion_test(corpus: C7Corpus, n_cycles: int) -> bool:
    ...
    Returns proves_load_bearing (bool).
    """
    ...
    return receipt.proves_load_bearing
...
def run_selftest(n_cycles: int = 3) -> None:
    ...
    proves_load_bearing = assert_c7_deletion_test(corpus, n_cycles=n_cycles + 2)
    ...
    receipt = {
        ...
        "proves_load_bearing": proves_load_bearing,
