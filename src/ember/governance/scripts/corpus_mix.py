...
Run:       python src/ember/governance/scripts/corpus_mix.py --mix-stats
Selftest:  python src/ember/governance/scripts/corpus_mix.py --selftest   (fixture, no network)
"""
import argparse
import json
import math
...
# issue2015 exact-local-import:src/ember/governance/scripts/tokenizer_freeze.py
...
_ember_dc2052625e15ccaa_existing = []
for _ember_dc2052625e15ccaa_alias in _ember_dc2052625e15ccaa_aliases:
    _ember_dc2052625e15ccaa_candidate = _ember_dc2052625e15ccaa_sys.modules.get(_ember_dc2052625e15ccaa_alias)
    if _ember_dc2052625e15ccaa_candidate is not None and all(_ember_dc2052625e15ccaa_candidate is not item for item in _ember_dc2052625e15ccaa_existing):
        _ember_dc2052625e15ccaa_existing.append(_ember_dc2052625e15ccaa_candidate)
if len(_ember_dc2052625e15ccaa_existing) > 1:
    raise ImportError('EXACT_LOCAL_IMPORT_IDENTITY_COLLISION:src/ember/governance/scripts/tokenizer_freeze.py')
if _ember_dc2052625e15ccaa_existing:
    _ember_dc2052625e15ccaa_module = _ember_dc2052625e15ccaa_existing[0]
    _ember_dc2052625e15ccaa_observed = getattr(_ember_dc2052625e15ccaa_module, '__file__', None)
    if _ember_dc2052625e15ccaa_observed is None or _ember_dc2052625e15ccaa_Path(_ember_dc2052625e15ccaa_observed).resolve() != _ember_dc2052625e15ccaa_path:
        raise ImportError('EXACT_LOCAL_IMPORT_WRONG_TARGET:src/ember/governance/scripts/tokenizer_freeze.py')
else:
    _ember_dc2052625e15ccaa_spec = _ember_dc2052625e15ccaa_importlib.spec_from_file_location('_ember_issue2015_dc2052625e15ccaa', _ember_dc2052625e15ccaa_path)
    if _ember_dc2052625e15ccaa_spec is None or _ember_dc2052625e15ccaa_spec.loader is None:
        raise ImportError('EXACT_LOCAL_IMPORT_SPEC_INVALID:src/ember/governance/scripts/tokenizer_freeze.py')
    _ember_dc2052625e15ccaa_module = _ember_dc2052625e15ccaa_importlib.module_from_spec(_ember_dc2052625e15ccaa_spec)
    for _ember_dc2052625e15ccaa_alias in _ember_dc2052625e15ccaa_aliases:
        _ember_dc2052625e15ccaa_prior = _ember_dc2052625e15ccaa_sys.modules.get(_ember_dc2052625e15ccaa_alias)
        if _ember_dc2052625e15ccaa_prior is not None and _ember_dc2052625e15ccaa_prior is not _ember_dc2052625e15ccaa_module:
            raise ImportError('EXACT_LOCAL_IMPORT_ALIAS_COLLISION:src/ember/governance/scripts/tokenizer_freeze.py')
        _ember_dc2052625e15ccaa_sys.modules[_ember_dc2052625e15ccaa_alias] = _ember_dc2052625e15ccaa_module
    try:
        _ember_dc2052625e15ccaa_spec.loader.exec_module(_ember_dc2052625e15ccaa_module)
    except BaseException:
        for _ember_dc2052625e15ccaa_alias in _ember_dc2052625e15ccaa_aliases:
            if _ember_dc2052625e15ccaa_sys.modules.get(_ember_dc2052625e15ccaa_alias) is _ember_dc2052625e15ccaa_module:
                _ember_dc2052625e15ccaa_sys.modules.pop(_ember_dc2052625e15ccaa_alias, None)
        raise
for _ember_dc2052625e15ccaa_alias in _ember_dc2052625e15ccaa_aliases:
    _ember_dc2052625e15ccaa_prior = _ember_dc2052625e15ccaa_sys.modules.get(_ember_dc2052625e15ccaa_alias)
    if _ember_dc2052625e15ccaa_prior is not None and _ember_dc2052625e15ccaa_prior is not _ember_dc2052625e15ccaa_module:
        raise ImportError('EXACT_LOCAL_IMPORT_ALIAS_COLLISION:src/ember/governance/scripts/tokenizer_freeze.py')
    _ember_dc2052625e15ccaa_sys.modules[_ember_dc2052625e15ccaa_alias] = _ember_dc2052625e15ccaa_module
tf = _ember_dc2052625e15ccaa_module
# issue2015 exact-local-import-end:src/ember/governance/scripts/tokenizer_freeze.py  # noqa: E402 — reuse the proven primitives
