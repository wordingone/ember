...
LR_ADAMW = 3e-4          # domains/model/configs/v0-pretrain-config.json optimizer.lr_adamw
WEIGHT_DECAY = 0.1       # domains/model/configs/v0-pretrain-config.json optimizer.weight_decay
