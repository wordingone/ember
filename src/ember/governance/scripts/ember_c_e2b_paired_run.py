...
ember-goalforge/src/ember/governance/scripts/ember_totality/test_c_e2b.py's check_paired_surpass().
...
def _fallback_score_founder_likeness_v1_leg(
    ...
    when src/ember/governance/scripts/ember_c_e2b_founder_likeness.py is not yet landed -- per
...
def build_receipt(
    ...
    receipt = {
        ...
        "ts": _ts_iso(),
        "mode": mode,
        "script": "src/ember/governance/scripts/ember_c_e2b_paired_run.py",
