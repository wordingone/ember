...
# issue2015 exact-local-import-end:src/ember/infrastructure/tools/ember-restart-3b/repository_layout.py  # noqa: E402
...
A1_CONFIG_SHA256 = "a9f9ba115dc8e139e18c528b2a3e13060ab874787e8f944bfaf4fc125fb23d80"
...
def load_git_env_hardening_module():
    ...
    module_path = pathlib.Path(__file__).resolve().parents[5] / GIT_ENV_HARDENING_MODULE_RELATIVE_PATH
    specification = importlib.util.spec_from_file_location(
...
def _validate_tier2_authority_inputs(
    ...
    threshold_sha = _load_json(
        repo_root / "src" / "ember" / "infrastructure" / "tools" / "ember-restart-3b" / "ember-restart-3b-a1.json",
        "canonical A1 config",
...
def _apportion_a1_step_energy(
    ...
    if not receipt_path or not sidecar_disclosure.get("receipt_written"):
        ...
        return
    module_path = repo_root / "src" / "ember" / "infrastructure" / "tools" / "ember-restart-3b" / "a1_energy_apportionment.py"
...
def _finalize_a1_packet_a(repo_root: pathlib.Path, launch: ValidatedLaunch) -> None:
    ...
    module_path = repo_root / "src" / "ember" / "infrastructure" / "tools" / "ember-restart-3b" / (
    ...
    try:
        ...
        common = {
            ...
            "thresholds_path": repo_root / "docs" / "domains" / "governance" / "spec" / "ember02-preregistration-thresholds-v1.json",
...
def _validate_tier1_host_setup_contract(
    ...
    try:
        ...
        # issue2015 exact-local-import:src/ember/infrastructure/tools/ember-restart-3b/host_setup_contract.py
        ...
        _ember_476f08b55fb79131_path = _ember_476f08b55fb79131_Path(__file__).resolve().parent.joinpath('host_setup_contract.py')
        if not _ember_476f08b55fb79131_path.is_file():
            raise ImportError('EXACT_LOCAL_IMPORT_TARGET_MISSING:src/ember/infrastructure/tools/ember-restart-3b/host_setup_contract.py')
        _ember_476f08b55fb79131_aliases = ('_ember_issue2015_476f08b55fb79131', 'host_setup_contract', 'src.ember.infrastructure.tools.ember-restart-3b.host_setup_contract')
        ...
        if len(_ember_476f08b55fb79131_existing) > 1:
            raise ImportError('EXACT_LOCAL_IMPORT_IDENTITY_COLLISION:src/ember/infrastructure/tools/ember-restart-3b/host_setup_contract.py')
        if _ember_476f08b55fb79131_existing:
            ...
            if _ember_476f08b55fb79131_observed is None or _ember_476f08b55fb79131_Path(_ember_476f08b55fb79131_observed).resolve() != _ember_476f08b55fb79131_path:
                raise ImportError('EXACT_LOCAL_IMPORT_WRONG_TARGET:src/ember/infrastructure/tools/ember-restart-3b/host_setup_contract.py')
        else:
            ...
            if _ember_476f08b55fb79131_spec is None or _ember_476f08b55fb79131_spec.loader is None:
                raise ImportError('EXACT_LOCAL_IMPORT_SPEC_INVALID:src/ember/infrastructure/tools/ember-restart-3b/host_setup_contract.py')
            ...
            for _ember_476f08b55fb79131_alias in _ember_476f08b55fb79131_aliases:
                ...
                if _ember_476f08b55fb79131_prior is not None and _ember_476f08b55fb79131_prior is not _ember_476f08b55fb79131_module:
                    raise ImportError('EXACT_LOCAL_IMPORT_ALIAS_COLLISION:src/ember/infrastructure/tools/ember-restart-3b/host_setup_contract.py')
        ...
        # issue2015 exact-local-import-end:src/ember/infrastructure/tools/ember-restart-3b/host_setup_contract.py
