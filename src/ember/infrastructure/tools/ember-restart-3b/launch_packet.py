...
def _tools_dir(root: Path) -> Path:
    return root / "src" / "ember" / "infrastructure" / "tools" / "ember-restart-3b"
...
def preflight_recovery(cfg: dict, root: Path) -> dict:
    ...
    try:
        ...
        _ember_cb39c9ced8203942_path = _ember_cb39c9ced8203942_Path(__file__).resolve().parent.joinpath('verify_capability_record.py')
        ...
        _ember_cb39c9ced8203942_aliases = ('_ember_issue2015_cb39c9ced8203942', 'src.ember.infrastructure.tools.ember-restart-3b.verify_capability_record', 'verify_capability_record')
...
def named_launch_command(cfg: dict, identity: dict) -> dict:
    ...
    Naming it here would be a FALSE command. src/ember/training/pretrain.py
