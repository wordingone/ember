...
_ember_61c2e2139a555ae2_path = _ember_61c2e2139a555ae2_Path(__file__).resolve().parent.joinpath('a1_checkpoint.py')
...
_ember_61c2e2139a555ae2_aliases = ('_ember_issue2015_61c2e2139a555ae2', 'a1_checkpoint', 'src.ember.infrastructure.tools.ember-restart-3b.a1_checkpoint')
...
_ember_e5dc614a4e45f2e7_path = _ember_e5dc614a4e45f2e7_Path(__file__).resolve().parent.joinpath('a1_optimizer.py')
...
_ember_e5dc614a4e45f2e7_aliases = ('_ember_issue2015_e5dc614a4e45f2e7', 'a1_optimizer', 'src.ember.infrastructure.tools.ember-restart-3b.a1_optimizer')
...
def run_dense_a1(
    *,
    ...
    config_path = Path(repo_root) / "src" / "ember" / "infrastructure" / "tools" / "ember-restart-3b" / "ember-restart-3b-a1.json"
