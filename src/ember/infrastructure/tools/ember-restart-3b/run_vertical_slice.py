...
_ember_51e1a79771640009_path = _ember_51e1a79771640009_Path(__file__).resolve().parent.joinpath('durable_io.py')
...
_ember_51e1a79771640009_aliases = ('_ember_issue2015_51e1a79771640009', 'durable_io', 'src.ember.infrastructure.tools.ember-restart-3b.durable_io')
...
_ember_281d174fea1a732b_path = _ember_281d174fea1a732b_Path(__file__).resolve().parent.joinpath('semantic_contract.py')
...
_ember_281d174fea1a732b_aliases = ('_ember_issue2015_281d174fea1a732b', 'semantic_contract', 'src.ember.infrastructure.tools.ember-restart-3b.semantic_contract')
...
_ember_35f35916a9155600_path = _ember_35f35916a9155600_Path(__file__).resolve().parent.joinpath('optimizer_transition.py')
...
_ember_35f35916a9155600_aliases = ('_ember_issue2015_35f35916a9155600', 'optimizer_transition', 'src.ember.infrastructure.tools.ember-restart-3b.optimizer_transition')
...
_ember_5f50765f1675ddc7_path = _ember_5f50765f1675ddc7_Path(__file__).resolve().parent.joinpath('step2_realization_registry.py')
...
_ember_5f50765f1675ddc7_aliases = ('_ember_issue2015_5f50765f1675ddc7', 'step2_realization_registry', 'src.ember.infrastructure.tools.ember-restart-3b.step2_realization_registry')
...
_ember_f216cdc78c9d2d43_path = _ember_f216cdc78c9d2d43_Path(__file__).resolve().parent.joinpath('train.py')
...
_ember_f216cdc78c9d2d43_aliases = ('_ember_issue2015_f216cdc78c9d2d43', 'src.ember.infrastructure.tools.ember-restart-3b.train', 'train')
...
_ember_24be29e78b31e759_path = _ember_24be29e78b31e759_Path(__file__).resolve().parent.joinpath('a1_tier2_contract.py')
...
_ember_24be29e78b31e759_aliases = ('_ember_issue2015_24be29e78b31e759', 'a1_tier2_contract', 'src.ember.infrastructure.tools.ember-restart-3b.a1_tier2_contract')
...
_ember_f733b674b04175d9_path = _ember_f733b674b04175d9_Path(__file__).resolve().parent.joinpath('a1_tier2_execution.py')
...
_ember_f733b674b04175d9_aliases = ('_ember_issue2015_f733b674b04175d9', 'a1_tier2_execution', 'src.ember.infrastructure.tools.ember-restart-3b.a1_tier2_execution')
    ...
    *, inventory_path: Path, output_root: Path, source_commit: str, run_id: str,
    ...
    try:
        ...
        checkpoint = {
            ...
            "contract_sha256": _sha256(Path(__file__).resolve().parents[5] / "src" / "ember" / "governance" / "scripts" / "ember_restart" / "contract.py"),
...
def run_governed_vertical(
    *,
    ...
    config_path = Path(__file__).resolve().parents[5] / "configs" / "ember-restart-3b.json"
...
def authorize_production_resume_checkpoint(
    ...
    *,
    ...
    if optimizer_transition_registry is not None:
        ...
        current_model_config = Path(__file__).resolve().parents[5] / "configs" / "ember-restart-3b.json"
...
def _execute_realization_counter(
    *,
    ...
    counter_path = root / "src" / "ember" / "infrastructure" / "tools" / "ember-restart-3b" / "parameter_counter.py"
