...
# issue2015 exact-local-import:tools/ember-restart-3b/a1_execution.py
...
_ember_dae9355feddb7be8_path = _ember_dae9355feddb7be8_Path(__file__).resolve().parents[5].joinpath('tools', 'ember-restart-3b', 'a1_execution.py')
if not _ember_dae9355feddb7be8_path.is_file():
    raise ImportError('EXACT_LOCAL_IMPORT_TARGET_MISSING:tools/ember-restart-3b/a1_execution.py')
_ember_dae9355feddb7be8_aliases = ('_ember_issue2015_dae9355feddb7be8', 'a1_execution', 'tools.ember-restart-3b.a1_execution')
...
if len(_ember_dae9355feddb7be8_existing) > 1:
    raise ImportError('EXACT_LOCAL_IMPORT_IDENTITY_COLLISION:tools/ember-restart-3b/a1_execution.py')
if _ember_dae9355feddb7be8_existing:
    ...
    if _ember_dae9355feddb7be8_observed is None or _ember_dae9355feddb7be8_Path(_ember_dae9355feddb7be8_observed).resolve() != _ember_dae9355feddb7be8_path:
        raise ImportError('EXACT_LOCAL_IMPORT_WRONG_TARGET:tools/ember-restart-3b/a1_execution.py')
else:
    ...
    if _ember_dae9355feddb7be8_spec is None or _ember_dae9355feddb7be8_spec.loader is None:
        raise ImportError('EXACT_LOCAL_IMPORT_SPEC_INVALID:tools/ember-restart-3b/a1_execution.py')
    ...
    for _ember_dae9355feddb7be8_alias in _ember_dae9355feddb7be8_aliases:
        ...
        if _ember_dae9355feddb7be8_prior is not None and _ember_dae9355feddb7be8_prior is not _ember_dae9355feddb7be8_module:
            raise ImportError('EXACT_LOCAL_IMPORT_ALIAS_COLLISION:tools/ember-restart-3b/a1_execution.py')
...
# issue2015 exact-local-import-end:tools/ember-restart-3b/a1_execution.py
