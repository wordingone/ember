...
# issue2015 exact-local-import:src/ember/infrastructure/tools/ember-restart-3b/input_identity.py
...
_ember_420977719a554907_path = _ember_420977719a554907_Path(__file__).resolve().parent.joinpath('input_identity.py')
if not _ember_420977719a554907_path.is_file():
    raise ImportError('EXACT_LOCAL_IMPORT_TARGET_MISSING:src/ember/infrastructure/tools/ember-restart-3b/input_identity.py')
_ember_420977719a554907_aliases = ('_ember_issue2015_420977719a554907', 'input_identity', 'src.ember.infrastructure.tools.ember-restart-3b.input_identity')
...
if len(_ember_420977719a554907_existing) > 1:
    raise ImportError('EXACT_LOCAL_IMPORT_IDENTITY_COLLISION:src/ember/infrastructure/tools/ember-restart-3b/input_identity.py')
if _ember_420977719a554907_existing:
    ...
    if _ember_420977719a554907_observed is None or _ember_420977719a554907_Path(_ember_420977719a554907_observed).resolve() != _ember_420977719a554907_path:
        raise ImportError('EXACT_LOCAL_IMPORT_WRONG_TARGET:src/ember/infrastructure/tools/ember-restart-3b/input_identity.py')
else:
    ...
    if _ember_420977719a554907_spec is None or _ember_420977719a554907_spec.loader is None:
        raise ImportError('EXACT_LOCAL_IMPORT_SPEC_INVALID:src/ember/infrastructure/tools/ember-restart-3b/input_identity.py')
    ...
    for _ember_420977719a554907_alias in _ember_420977719a554907_aliases:
        ...
        if _ember_420977719a554907_prior is not None and _ember_420977719a554907_prior is not _ember_420977719a554907_module:
            raise ImportError('EXACT_LOCAL_IMPORT_ALIAS_COLLISION:src/ember/infrastructure/tools/ember-restart-3b/input_identity.py')
...
# issue2015 exact-local-import-end:src/ember/infrastructure/tools/ember-restart-3b/input_identity.py
# issue2015 exact-local-import:src/ember/infrastructure/tools/ember-restart-3b/text_lab_corpus.py
...
_ember_19a226af4399225d_path = _ember_19a226af4399225d_Path(__file__).resolve().parent.joinpath('text_lab_corpus.py')
if not _ember_19a226af4399225d_path.is_file():
    raise ImportError('EXACT_LOCAL_IMPORT_TARGET_MISSING:src/ember/infrastructure/tools/ember-restart-3b/text_lab_corpus.py')
_ember_19a226af4399225d_aliases = ('_ember_issue2015_19a226af4399225d', 'text_lab_corpus', 'src.ember.infrastructure.tools.ember-restart-3b.text_lab_corpus')
...
if len(_ember_19a226af4399225d_existing) > 1:
    raise ImportError('EXACT_LOCAL_IMPORT_IDENTITY_COLLISION:src/ember/infrastructure/tools/ember-restart-3b/text_lab_corpus.py')
if _ember_19a226af4399225d_existing:
    ...
    if _ember_19a226af4399225d_observed is None or _ember_19a226af4399225d_Path(_ember_19a226af4399225d_observed).resolve() != _ember_19a226af4399225d_path:
        raise ImportError('EXACT_LOCAL_IMPORT_WRONG_TARGET:src/ember/infrastructure/tools/ember-restart-3b/text_lab_corpus.py')
else:
    ...
    if _ember_19a226af4399225d_spec is None or _ember_19a226af4399225d_spec.loader is None:
        raise ImportError('EXACT_LOCAL_IMPORT_SPEC_INVALID:src/ember/infrastructure/tools/ember-restart-3b/text_lab_corpus.py')
    ...
    for _ember_19a226af4399225d_alias in _ember_19a226af4399225d_aliases:
        ...
        if _ember_19a226af4399225d_prior is not None and _ember_19a226af4399225d_prior is not _ember_19a226af4399225d_module:
            raise ImportError('EXACT_LOCAL_IMPORT_ALIAS_COLLISION:src/ember/infrastructure/tools/ember-restart-3b/text_lab_corpus.py')
...
# issue2015 exact-local-import-end:src/ember/infrastructure/tools/ember-restart-3b/text_lab_corpus.py
