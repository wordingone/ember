...
Usage:
    python src/ember/infrastructure/tools/ember-restart-3b/remint_text_lab_input_identity.py --check
    ...
    python src/ember/infrastructure/tools/ember-restart-3b/remint_text_lab_input_identity.py --write
