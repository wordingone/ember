...
for _ember_19a226af4399225d_alias in _ember_19a226af4399225d_aliases:
    ...
    if _ember_19a226af4399225d_prior is not None and _ember_19a226af4399225d_prior is not _ember_19a226af4399225d_module:
        raise ImportError('EXACT_LOCAL_IMPORT_ALIAS_COLLISION:src/ember/infrastructure/tools/ember-restart-3b/text_lab_corpus.py')
    _ember_19a226af4399225d_sys.modules[_ember_19a226af4399225d_alias] = _ember_19a226af4399225d_module
_authority_split_digest = getattr(_ember_19a226af4399225d_module, '_authority_split_root')
    ...
    *, repo: Path, source_custody: Path, source_receipt_name: str,
    ...
    return {
        ...
        "producer": {
            ...
            "sha256": _sha((repo / "src" / "ember" / "infrastructure" / "tools" / "ember-restart-3b" / "project_text_lab_custody_paths.py").read_bytes()),
        },
    }
...
def build_projected_packet(
    *,
    ...
    corpus["train_root_sha256"] = _authority_split_digest(rows, "train")
    corpus["heldout_root_sha256"] = _authority_split_digest(rows, "heldout")
