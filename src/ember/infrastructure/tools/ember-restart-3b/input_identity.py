...
def resolve_input_identity(
    *,
    ...
    if artifact_id == "owned-four-domain-production-rung-v1":
        ...
        _ember_3829b656d5b6642f_path = _ember_3829b656d5b6642f_Path(__file__).resolve().parent.joinpath('production_rung.py')
        ...
        _ember_3829b656d5b6642f_aliases = ('_ember_issue2015_3829b656d5b6642f', 'production_rung', 'src.ember.infrastructure.tools.ember-restart-3b.production_rung')
