...
and src/ember/infrastructure/tools/check_names_hashed.py (issue #91).
...
Run: python src/ember/infrastructure/tools/repo_guard_selftest.py
"""
import hashlib
import json
import re
...
GUARD_SUPPORT_FILES = [
    ".gitattributes",
    "tools/repo-guard.sh",
    "src/ember/infrastructure/tools/powershell-launcher-shape-guard.ps1",
    "src/ember/infrastructure/tools/run-python-hidden.sh",
    "src/ember/infrastructure/tools/check_line_endings.py",
    ...
    "src/ember/governance/scripts/check_changed_receipts.py",
    "src/ember/governance/scripts/gate_provenance.py",
    "src/ember/governance/scripts/authority_supersession_gate.py",
    "src/ember/governance/scripts/verify_authority_supersession_crosswalk.py",
    "src/ember/governance/scripts/oldest_issue_disposition.py",
    ...
    "docs/domains/governance/authority/REDACTIONS.md",
    ...
    "domains/model/configs/nck-baseline/nck-invariants.json",
    "domains/model/configs/nck-baseline/nck-invariants.authority.json",
    "domains/model/configs/nck-c10.json",
    "domains/model/configs/nck-invariants.json",
    "domains/model/configs/nck-invariants.authority.json",
    "domains/model/configs/nck-schedule.json",
    "domains/model/configs/owned-core-widen-config.json",
    "domains/model/configs/v0-multimodal-config.json",
    "domains/model/configs/v0-pretrain-config.json",
    "domains/model/configs/v1-pretrain-config.json",
...
def write_fixture_crosswalk(root: Path) -> None:
    ...
    evidence = [{"path": "docs/domains/governance/authority/ember-authority-matrix.md", "sha256": matrix_sha}]
    payload = {
...
def test_split_kernel_hashed_scan_covers_every_subject_guard_surface():
    ...
    for relative in (
        ...
        "src/ember/infrastructure/tools/.repo-guard-denylist.example",
        "src/ember/infrastructure/tools/repo-guard-names-exclude.cfg",
    ):
...
def test_required_workflow_uses_base_pinned_kernel():
    ...
    assert "python -m src.ember.governance.scripts.github.live_pr_policy" in text
