...
// are the audit-scoped restatement of docs/domains/governance/contracts/goal-mode-mechanism.md ("Selection
...
// docs/domains/governance/contracts/goal-mode-mechanism.md is the sole document floor.
//
...
// (docs/domains/governance/contracts/goal-mode-mechanism.md "Selection and persistence")
