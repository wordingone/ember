...
if __package__:
    from . import ember_v0_decoder as _ember_v0_compat_impl
else:
    ...
    try:
        import ember_v0_decoder as _ember_v0_compat_impl
    finally:
        _ember_v0_compat_sys.path.remove(_ember_v0_compat_dir)

if _EmberV0CompatPath(_ember_v0_compat_impl.__file__).resolve() != _EmberV0CompatPath(__file__).resolve().with_name("ember_v0_decoder.py"):
