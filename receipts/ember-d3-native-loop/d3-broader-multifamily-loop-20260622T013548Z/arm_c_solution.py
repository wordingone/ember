...
OUTPUTS = [
    ...
    "pred_results/pred_get_reactant_bag_other_reactions_reaction_idx_{rxn_idx}.csv",
...
def write_task18_family() -> None:
    ...
    molecules = []
    for n in range(5, 51):
        molecules.append("C" * n)
    for n in range(5, 50):
        molecules.append("C" * n + "O")
        molecules.append("C" * n + "N")
    molecules = molecules[:132]
    for i, smiles in enumerate(molecules):
        fitness = 0.72 + 0.18 * ((i % 23) / 22.0)
