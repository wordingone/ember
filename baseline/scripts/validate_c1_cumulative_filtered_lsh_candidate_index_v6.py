#!/usr/bin/env python3
"""Validate a v6-filtered LSH candidate-index materialization receipt."""
...
VALID_VERDICT = "C1_CUMULATIVE_FILTERED_LSH_CANDIDATE_INDEX_V6_MATERIALIZED_NOT_COMPLETION"
...
def main() -> int:
    ...
    result = {
        ...
        "verdict": "C1_CUMULATIVE_FILTERED_LSH_CANDIDATE_INDEX_V6_VALIDATED" if not failures else "C1_CUMULATIVE_FILTERED_LSH_CANDIDATE_INDEX_V6_INVALID",
