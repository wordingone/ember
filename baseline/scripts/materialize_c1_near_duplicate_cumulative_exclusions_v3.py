#!/usr/bin/env python3
"""Materialize cumulative C1 near-duplicate exclusions v3."""
...
TARGETED_MANIFEST = "fragments/c1-near-duplicate-cumulative-exclusions-v2-2026-06-30.jsonl"
TARGETED_RECEIPT = "receipts/4090-near-duplicate-cumulative-exclusion-manifest-v2-2026-06-30.json"
CHALLENGE_RECEIPT = "receipts/4090-cumulative-filtered-challenge-remediation-v3-2026-06-30.json"
CHALLENGE_VALIDATION = "receipts/4090-cumulative-filtered-challenge-remediation-v3-validation-2026-06-30.json"
OUT_MANIFEST = "fragments/c1-near-duplicate-cumulative-exclusions-v3-2026-06-30.jsonl"
VERDICT = "C1_NEAR_DUPLICATE_CUMULATIVE_EXCLUSION_MANIFEST_V3_READY"
...
def main() -> int:
    ...
    for row in challenge_receipt.get("exclusions", []):
        cumulative.append({
            ...
            "shard": str(row["shard"]),
            "token_len": int(row["token_len"]),
            "source": "cumulative_filtered_v2_challenge_remediation",
    ...
    result = {
        "kind": "single_4090_c1_near_duplicate_cumulative_exclusion_manifest_v3",
        "created_at_utc": datetime.now(timezone.utc).replace(microsecond=0).isoformat().replace("+00:00", "Z"),
        "verdict": VERDICT if not failures else "C1_NEAR_DUPLICATE_CUMULATIVE_EXCLUSION_MANIFEST_V3_INVALID",
        ...
        "completion_limit": "This materializes cumulative discovered-cluster exclusions v3 only. It is not an all-pairs near-duplicate PASS, not a full-corpus MinHash proof, not eval-contamination evidence, and not overall baseline completion.",
    }
