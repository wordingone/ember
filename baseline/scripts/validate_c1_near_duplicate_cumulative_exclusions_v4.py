#!/usr/bin/env python3
"""Validate cumulative C1 near-duplicate exclusion materialization v4."""
...
RECEIPT = "receipts/4090-near-duplicate-cumulative-exclusion-manifest-v4-2026-06-30.json"
VALIDATION_RECEIPT = "receipts/4090-cumulative-filtered-challenge-remediation-v4-validation-2026-06-30.json"
SOURCE_TARGETED_RECEIPT = "receipts/4090-near-duplicate-cumulative-exclusion-manifest-v3-2026-06-30.json"
SOURCE_CHALLENGE_RECEIPT = "receipts/4090-cumulative-filtered-challenge-remediation-v4-2026-06-30.json"
MANIFEST = "fragments/c1-near-duplicate-cumulative-exclusions-v4-2026-06-30.jsonl"
...
def main() -> int:
    ...
    if source_counts.get("cumulative_v3") != targeted_count:
        failures.append({"code": "targeted_source_count_mismatch", "source_counts": source_counts, "expected": targeted_count})
    if source_counts.get("cumulative_filtered_v3_challenge_remediation") != challenge_count:
    ...
    result = {
        ...
        "verdict": "C1_NEAR_DUPLICATE_CUMULATIVE_EXCLUSION_MANIFEST_V4_VALIDATED" if not failures else "C1_NEAR_DUPLICATE_CUMULATIVE_EXCLUSION_MANIFEST_V4_INVALID",
        ...
        "completion_limit": "This validates cumulative discovered-cluster exclusions v4 only. It is not all-pairs/full-corpus near-duplicate PASS evidence and not overall baseline completion.",
    }
