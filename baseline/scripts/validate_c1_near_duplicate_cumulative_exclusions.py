#!/usr/bin/env python3
"""Validate cumulative C1 near-duplicate exclusion materialization."""
...
RECEIPT = "receipts/4090-near-duplicate-cumulative-exclusion-manifest-v2-2026-06-30.json"
VALIDATION_RECEIPT = "receipts/4090-targeted-filtered-challenge-remediation-validation-2026-06-30.json"
SOURCE_TARGETED_RECEIPT = "receipts/4090-near-duplicate-targeted-exclusion-manifest-2026-06-30.json"
SOURCE_CHALLENGE_RECEIPT = "receipts/4090-targeted-filtered-challenge-remediation-2026-06-30.json"
MANIFEST = "fragments/c1-near-duplicate-cumulative-exclusions-v2-2026-06-30.jsonl"
...
def main() -> int:
    ...
    if source_counts.get("targeted_cluster_expansion") != targeted_count:
        failures.append({"code": "targeted_source_count_mismatch", "source_counts": source_counts, "expected": targeted_count})
    if source_counts.get("targeted_filtered_challenge_remediation") != challenge_count:
    ...
    result = {
        ...
        "verdict": "C1_NEAR_DUPLICATE_CUMULATIVE_EXCLUSION_MANIFEST_V2_VALIDATED" if not failures else "C1_NEAR_DUPLICATE_CUMULATIVE_EXCLUSION_MANIFEST_V2_INVALID",
        ...
        "completion_limit": "This validates cumulative discovered-cluster exclusions only. It is not all-pairs/full-corpus near-duplicate PASS evidence and not overall baseline completion.",
    }
