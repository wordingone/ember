#!/usr/bin/env python3
"""Materialize v7-filtered LSH collision-bucket candidate postings.
...
VERDICT = "C1_CUMULATIVE_FILTERED_LSH_CANDIDATE_INDEX_V7_MATERIALIZED_NOT_COMPLETION"
...
def main() -> int:
    ...
    result = {
        "kind": "single_4090_c1_cumulative_filtered_lsh_candidate_index_v7",
        "created_at_utc": datetime.now(timezone.utc).replace(microsecond=0).isoformat().replace("+00:00", "Z"),
        "verdict": VERDICT if not failures else "C1_CUMULATIVE_FILTERED_LSH_CANDIDATE_INDEX_V7_INVALID",
        ...
        "method": "two-pass v7-filtered LSH candidate-index materialization; first pass counts selected-band buckets, second pass writes only collision bucket members for exact Jaccard adjudication",
