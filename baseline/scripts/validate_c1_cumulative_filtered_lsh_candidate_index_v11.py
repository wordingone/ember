#!/usr/bin/env python3
"""Validate a v11-filtered LSH candidate-index materialization receipt."""
...
VALID_VERDICT = "C1_CUMULATIVE_FILTERED_LSH_CANDIDATE_INDEX_V11_MATERIALIZED_NOT_COMPLETION"
...
def main() -> int:
    ...
    result = {
        ...
        "verdict": "C1_CUMULATIVE_FILTERED_LSH_CANDIDATE_INDEX_V11_VALIDATED" if not failures else "C1_CUMULATIVE_FILTERED_LSH_CANDIDATE_INDEX_V11_INVALID",
