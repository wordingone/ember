#!/usr/bin/env python3
"""Validate deterministic remediation for the targeted-filtered C1 challenge."""
...
RECEIPT = "receipts/4090-targeted-filtered-challenge-remediation-2026-06-30.json"
SOURCE_RECEIPT = "receipts/4090-targeted-filtered-near-duplicate-sample-2026-06-30.json"
...
def main() -> int:
    ...
    for row in exclusions:
        ...
        if row.get("kept") is not False or row.get("reason") != "targeted_filtered_challenge_near_duplicate_component":
    ...
    if "challenge-sample remediation only" not in str(receipt.get("scope_limit", "")):
    ...
    result = {
        ...
        "verdict": "C1_TARGETED_FILTERED_CHALLENGE_REMEDIATION_VALIDATED" if not failures else "C1_TARGETED_FILTERED_CHALLENGE_REMEDIATION_INVALID",
        ...
        "completion_limit": "This validates deterministic challenge-sample remediation only. It is not full-corpus near-duplicate remediation, not a C1 hygiene pass, and not overall baseline completion.",
    }
