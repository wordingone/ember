#!/usr/bin/env python3
"""Exact-Jaccard adjudicate a v12-filtered LSH candidate index.
...
VERDICT_CLEAN = "C1_CUMULATIVE_FILTERED_LSH_CANDIDATE_INDEX_V12_EXACT_ADJUDICATION_NO_CROSSINGS_NOT_COMPLETION"
VERDICT_CROSSINGS = "C1_CUMULATIVE_FILTERED_LSH_CANDIDATE_INDEX_V12_EXACT_ADJUDICATION_CROSSINGS_FOUND_NOT_COMPLETION"
VERDICT_INVALID = "C1_CUMULATIVE_FILTERED_LSH_CANDIDATE_INDEX_V12_EXACT_ADJUDICATION_INVALID"
...
def main() -> int:
    ...
    result = {
        "kind": "single_4090_c1_cumulative_filtered_lsh_candidate_index_V12_exact_adjudication",
