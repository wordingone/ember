#!/usr/bin/env python3
"""Materialize a targeted near-duplicate filtered-corpus view receipt.
...
VERDICT = "C1_TARGETED_FILTERED_CORPUS_VIEW_READY_NOT_COMPLETION"
...
def main() -> int:
    ...
    result = {
        "kind": "single_4090_c1_targeted_filtered_corpus_view",
        ...
        "completion_limit": "This materializes a targeted filtered-corpus view for discovered near-duplicate clusters only. It is not an all-pairs near-duplicate PASS, not binary shard rewrite, not a full-corpus MinHash PASS, not eval-contamination evidence, and not overall baseline completion.",
    }
