#!/usr/bin/env python3
"""Validate exact adjudication over a v5-filtered LSH candidate index."""
...
VALID_VERDICTS = {
    "C1_CUMULATIVE_FILTERED_LSH_CANDIDATE_INDEX_V5_EXACT_ADJUDICATION_NO_CROSSINGS_NOT_COMPLETION",
    "C1_CUMULATIVE_FILTERED_LSH_CANDIDATE_INDEX_V5_EXACT_ADJUDICATION_CROSSINGS_FOUND_NOT_COMPLETION",
}
...
def main() -> int:
    ...
    result = {
        ...
        "verdict": "C1_CUMULATIVE_FILTERED_LSH_CANDIDATE_INDEX_V5_EXACT_ADJUDICATION_VALIDATED" if not failures else "C1_CUMULATIVE_FILTERED_LSH_CANDIDATE_INDEX_V5_EXACT_ADJUDICATION_INVALID",
