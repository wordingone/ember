#!/usr/bin/env python3
"""Validate the C1 cumulative-filtered v3 near-duplicate challenge sample receipt."""
...
RECEIPT = "receipts/4090-cumulative-filtered-near-duplicate-sample-v3-2026-06-30.json"
...
VALID_VERDICTS = {
    "C1_CUMULATIVE_FILTERED_NEAR_DUPLICATE_SAMPLE_V3_NO_CROSSING_CANDIDATES",
    "C1_CUMULATIVE_FILTERED_NEAR_DUPLICATE_SAMPLE_V3_CANDIDATES_FOUND",
}
...
def main() -> int:
    ...
    result = {
        ...
        "verdict": "C1_CUMULATIVE_FILTERED_NEAR_DUPLICATE_SAMPLE_V3_VALIDATED" if not failures else "C1_CUMULATIVE_FILTERED_NEAR_DUPLICATE_SAMPLE_V3_INVALID",
        ...
        "completion_limit": "This validates a cumulative-filtered v3 near-duplicate challenge sample only. It is not an all-pairs near-duplicate PASS, not eval-contamination evidence, and not overall baseline completion.",
    }
