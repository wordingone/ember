#!/usr/bin/env python3
"""Build deterministic v3 remediation from the cumulative-filtered v2 C1 challenge."""
...
CHALLENGE_RECEIPT = "receipts/4090-cumulative-filtered-near-duplicate-sample-v2-2026-06-30.json"
...
def main() -> int:
        ...
        for row in ordered[1:]:
            annotated = {
                **row,
                ...
                "kept": False,
                "reason": "cumulative_filtered_v2_challenge_near_duplicate_component",
            }
    ...
    result = {
        "kind": "single_4090_c1_cumulative_filtered_challenge_remediation_v3",
        "created_at_utc": datetime.now(timezone.utc).replace(microsecond=0).isoformat().replace("+00:00", "Z"),
        "verdict": "C1_CUMULATIVE_FILTERED_CHALLENGE_REMEDIATION_V3_PACKET_READY",
        ...
        "rule": "Within each connected component of above-threshold cumulative-filtered v2 challenge pairs, keep the lowest doc_index/doc_sha256 document and exclude the remaining documents before any C1 pass attempt.",
        "clusters": clusters,
        "exclusions": exclusions,
        "scope_limit": "This is a v3 remediation packet generated from cumulative-filtered v2 challenge-sample crossings only. It does not rewrite token shards and does not claim corpus-wide hygiene.",
        "completion_limit": "This is deterministic v3 remediation generated from cumulative-filtered v2 challenge-sample crossings only; all-pairs/full-corpus PASS remains required before C1 data hygiene or the overall baseline can complete.",
    }
