#!/usr/bin/env python3
"""Validate a v12-filtered LSH candidate-index materialization receipt."""
...
VALID_VERDICT = "C1_CUMULATIVE_FILTERED_LSH_CANDIDATE_INDEX_V12_MATERIALIZED_NOT_COMPLETION"
...
def main() -> int:
    ...
    result = {
        ...
        "verdict": "C1_CUMULATIVE_FILTERED_LSH_CANDIDATE_INDEX_V12_VALIDATED" if not failures else "C1_CUMULATIVE_FILTERED_LSH_CANDIDATE_INDEX_V12_INVALID",
