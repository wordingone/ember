...
| F05 | Goal/proof rule | `B:\M\ember-public\GOAL.md` | Requires field-level breakthrough over named prior, broader external/disjoint benchmark, zero-cost verification, deletion/revert sensitivity, and no paid leaderboard/API authority. | Mirror into self-improvement and publication contracts. |
