...
| F13 | Completion/coverage map | `<public-tree>\docs\ember-completeness.md` | Lists M15 E2B baseline, M38 proxy-speedrun harness, M47 arcade floor, and status flags (manifest rows renamed C→M in 2026-07-05). | Use as cross-reference for missing contracts and prior fragments. |
