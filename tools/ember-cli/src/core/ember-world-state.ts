...
//
// This is the ADAPTER: it binds the live goalforge contract tree's docs/domains/governance/authority/GOAL.md, its technical/
...
// docs/domains/governance/authority/GOAL.md is the authoritative goal surface -- "the GOVERNING CONTRACT is the goalforge contract
// repo's docs/domains/governance/authority/GOAL.md ... on any conflict, the contract wins"), never the tree this module itself
...
export interface EmberWorldState {
  ...
  understand: {
    goalTitle: string;
    topology: Claim[]; // one per "## " heading in docs/domains/governance/authority/GOAL.md -- organ anatomy + loop topology
  };
  interact: {
...
/** Extracts the H1 title (first "# " line) from docs/domains/governance/authority/GOAL.md text. */
