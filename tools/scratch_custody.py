...
# disposition: ADAPTER
# issue1949 old_path: tools/scratch_custody.py
# issue1949 new_path: src/ember/infrastructure/tools/scratch_custody.py
...
_issue1949_target = _issue1949_root.joinpath('src', 'ember', 'infrastructure', 'tools', 'scratch_custody.py')
if not _issue1949_target.is_file():
    raise ImportError("ISSUE1949_ADAPTER_TARGET_MISSING:src/ember/infrastructure/tools/scratch_custody.py")
_issue1949_name = "_ember_issue1949_5296f6ea9e0d2dcb"
...
if _issue1949_spec is None or _issue1949_spec.loader is None:
    raise ImportError("ISSUE1949_ADAPTER_SPEC_INVALID:src/ember/infrastructure/tools/scratch_custody.py")
