...
_ember_f5951795c08a31e2_path = _ember_f5951795c08a31e2_Path(__file__).resolve().parents[2].joinpath('src', 'ember', 'infrastructure', 'tools', 'ember-restart-3b', 'checkpoint_artifacts.py')
...
_ember_f5951795c08a31e2_aliases = ('_ember_issue2015_f5951795c08a31e2', 'checkpoint_artifacts', 'tools.ember-restart-3b.checkpoint_artifacts')
...
for _ember_f5951795c08a31e2_alias in _ember_f5951795c08a31e2_aliases:
    ...
    if _ember_f5951795c08a31e2_prior is not None and _ember_f5951795c08a31e2_prior is not _ember_f5951795c08a31e2_module:
        raise ImportError('EXACT_LOCAL_IMPORT_ALIAS_COLLISION:src/ember/infrastructure/tools/ember-restart-3b/checkpoint_artifacts.py')
    _ember_f5951795c08a31e2_sys.modules[_ember_f5951795c08a31e2_alias] = _ember_f5951795c08a31e2_module
CheckpointDeferredLowCommit = getattr(_ember_f5951795c08a31e2_module, 'CheckpointDeferredLowCommit')
_atomic_publish_no_replace = getattr(_ember_f5951795c08a31e2_module, '_atomic_publish_no_replace')
_default_optimizer_contract = getattr(_ember_f5951795c08a31e2_module, '_default_optimizer_contract')
_empty_failure_comparison_operands = getattr(_ember_f5951795c08a31e2_module, '_empty_failure_comparison_operands')
_normalize_failure_comparison_operands = getattr(_ember_f5951795c08a31e2_module, '_normalize_failure_comparison_operands')
_optimizer_realization = getattr(_ember_f5951795c08a31e2_module, '_optimizer_realization')
_select_detached_state = getattr(_ember_f5951795c08a31e2_module, '_select_detached_state')
_write_atomic = getattr(_ember_f5951795c08a31e2_module, '_write_atomic')
available_host_commit_bytes = getattr(_ember_f5951795c08a31e2_module, 'available_host_commit_bytes')
load_checkpoint_artifacts = getattr(_ember_f5951795c08a31e2_module, 'load_checkpoint_artifacts')
load_checkpoint_model_only_transition = getattr(_ember_f5951795c08a31e2_module, 'load_checkpoint_model_only_transition')
optimizer_covers_every_expert_route = getattr(_ember_f5951795c08a31e2_module, 'optimizer_covers_every_expert_route')
preflight_specialist_lineage_sources = getattr(_ember_f5951795c08a31e2_module, 'preflight_specialist_lineage_sources')
...
_ember_4108d33796031947_path = _ember_4108d33796031947_Path(__file__).resolve().parents[2].joinpath('src', 'ember', 'infrastructure', 'tools', 'ember-restart-3b', 'model.py')
...
_ember_4108d33796031947_aliases = ('_ember_issue2015_4108d33796031947', 'model', 'tools.ember-restart-3b.model')
...
_ember_b7d3b01fbe6c752d_path = _ember_b7d3b01fbe6c752d_Path(__file__).resolve().parents[2].joinpath('src', 'ember', 'infrastructure', 'tools', 'ember-restart-3b', 'pretrain.py')
...
_ember_b7d3b01fbe6c752d_aliases = ('_ember_issue2015_b7d3b01fbe6c752d', 'pretrain', 'tools.ember-restart-3b.pretrain')
...
if _ember_b7d3b01fbe6c752d_existing:
    ...
    try:
        ...
        for _ember_b7d3b01fbe6c752d_alias in _ember_b7d3b01fbe6c752d_aliases:
            if _ember_b7d3b01fbe6c752d_sys.modules.get(_ember_b7d3b01fbe6c752d_alias) is _ember_b7d3b01fbe6c752d_module:
                _ember_b7d3b01fbe6c752d_sys.modules.pop(_ember_b7d3b01fbe6c752d_alias, None)
        raise
for _ember_b7d3b01fbe6c752d_alias in _ember_b7d3b01fbe6c752d_aliases:
    _ember_b7d3b01fbe6c752d_prior = _ember_b7d3b01fbe6c752d_sys.modules.get(_ember_b7d3b01fbe6c752d_alias)
    if _ember_b7d3b01fbe6c752d_prior is not None and _ember_b7d3b01fbe6c752d_prior is not _ember_b7d3b01fbe6c752d_module:
...
atomic_replace_durable = getattr(_ember_51e1a79771640009_module, 'atomic_replace_durable')
...
# issue2015 exact-local-import:src/ember/infrastructure/tools/ember-restart-3b/semantic_contract.py
import importlib.util as _ember_281d174fea1a732b_importlib
import sys as _ember_281d174fea1a732b_sys
from pathlib import Path as _ember_281d174fea1a732b_Path
_ember_281d174fea1a732b_path = _ember_281d174fea1a732b_Path(__file__).resolve().parents[2].joinpath('src', 'ember', 'infrastructure', 'tools', 'ember-restart-3b', 'semantic_contract.py')
if not _ember_281d174fea1a732b_path.is_file():
    raise ImportError('EXACT_LOCAL_IMPORT_TARGET_MISSING:src/ember/infrastructure/tools/ember-restart-3b/semantic_contract.py')
_ember_281d174fea1a732b_aliases = ('_ember_issue2015_281d174fea1a732b', 'semantic_contract', 'tools.ember-restart-3b.semantic_contract')
_ember_281d174fea1a732b_existing = []
for _ember_281d174fea1a732b_alias in _ember_281d174fea1a732b_aliases:
    _ember_281d174fea1a732b_candidate = _ember_281d174fea1a732b_sys.modules.get(_ember_281d174fea1a732b_alias)
    if _ember_281d174fea1a732b_candidate is not None and all(_ember_281d174fea1a732b_candidate is not item for item in _ember_281d174fea1a732b_existing):
        _ember_281d174fea1a732b_existing.append(_ember_281d174fea1a732b_candidate)
if len(_ember_281d174fea1a732b_existing) > 1:
    raise ImportError('EXACT_LOCAL_IMPORT_IDENTITY_COLLISION:src/ember/infrastructure/tools/ember-restart-3b/semantic_contract.py')
if _ember_281d174fea1a732b_existing:
    _ember_281d174fea1a732b_module = _ember_281d174fea1a732b_existing[0]
    _ember_281d174fea1a732b_observed = getattr(_ember_281d174fea1a732b_module, '__file__', None)
    if _ember_281d174fea1a732b_observed is None or _ember_281d174fea1a732b_Path(_ember_281d174fea1a732b_observed).resolve() != _ember_281d174fea1a732b_path:
        raise ImportError('EXACT_LOCAL_IMPORT_WRONG_TARGET:src/ember/infrastructure/tools/ember-restart-3b/semantic_contract.py')
else:
    _ember_281d174fea1a732b_spec = _ember_281d174fea1a732b_importlib.spec_from_file_location('_ember_issue2015_281d174fea1a732b', _ember_281d174fea1a732b_path)
    if _ember_281d174fea1a732b_spec is None or _ember_281d174fea1a732b_spec.loader is None:
        raise ImportError('EXACT_LOCAL_IMPORT_SPEC_INVALID:src/ember/infrastructure/tools/ember-restart-3b/semantic_contract.py')
    _ember_281d174fea1a732b_module = _ember_281d174fea1a732b_importlib.module_from_spec(_ember_281d174fea1a732b_spec)
    for _ember_281d174fea1a732b_alias in _ember_281d174fea1a732b_aliases:
        _ember_281d174fea1a732b_prior = _ember_281d174fea1a732b_sys.modules.get(_ember_281d174fea1a732b_alias)
        if _ember_281d174fea1a732b_prior is not None and _ember_281d174fea1a732b_prior is not _ember_281d174fea1a732b_module:
            raise ImportError('EXACT_LOCAL_IMPORT_ALIAS_COLLISION:src/ember/infrastructure/tools/ember-restart-3b/semantic_contract.py')
        _ember_281d174fea1a732b_sys.modules[_ember_281d174fea1a732b_alias] = _ember_281d174fea1a732b_module
    try:
        _ember_281d174fea1a732b_spec.loader.exec_module(_ember_281d174fea1a732b_module)
    except BaseException:
        for _ember_281d174fea1a732b_alias in _ember_281d174fea1a732b_aliases:
            if _ember_281d174fea1a732b_sys.modules.get(_ember_281d174fea1a732b_alias) is _ember_281d174fea1a732b_module:
                _ember_281d174fea1a732b_sys.modules.pop(_ember_281d174fea1a732b_alias, None)
        raise
for _ember_281d174fea1a732b_alias in _ember_281d174fea1a732b_aliases:
    _ember_281d174fea1a732b_prior = _ember_281d174fea1a732b_sys.modules.get(_ember_281d174fea1a732b_alias)
    if _ember_281d174fea1a732b_prior is not None and _ember_281d174fea1a732b_prior is not _ember_281d174fea1a732b_module:
        raise ImportError('EXACT_LOCAL_IMPORT_ALIAS_COLLISION:src/ember/infrastructure/tools/ember-restart-3b/semantic_contract.py')
    _ember_281d174fea1a732b_sys.modules[_ember_281d174fea1a732b_alias] = _ember_281d174fea1a732b_module
semantic_model_contract_sha256 = getattr(_ember_281d174fea1a732b_module, 'semantic_model_contract_sha256')
# issue2015 exact-local-import-end:src/ember/infrastructure/tools/ember-restart-3b/semantic_contract.py
# issue2015 exact-local-import:src/ember/infrastructure/tools/ember-restart-3b/optimizer_transition.py
import importlib.util as _ember_35f35916a9155600_importlib
import sys as _ember_35f35916a9155600_sys
from pathlib import Path as _ember_35f35916a9155600_Path
_ember_35f35916a9155600_path = _ember_35f35916a9155600_Path(__file__).resolve().parents[2].joinpath('src', 'ember', 'infrastructure', 'tools', 'ember-restart-3b', 'optimizer_transition.py')
if not _ember_35f35916a9155600_path.is_file():
    raise ImportError('EXACT_LOCAL_IMPORT_TARGET_MISSING:src/ember/infrastructure/tools/ember-restart-3b/optimizer_transition.py')
_ember_35f35916a9155600_aliases = ('_ember_issue2015_35f35916a9155600', 'optimizer_transition', 'tools.ember-restart-3b.optimizer_transition')
_ember_35f35916a9155600_existing = []
for _ember_35f35916a9155600_alias in _ember_35f35916a9155600_aliases:
    _ember_35f35916a9155600_candidate = _ember_35f35916a9155600_sys.modules.get(_ember_35f35916a9155600_alias)
    if _ember_35f35916a9155600_candidate is not None and all(_ember_35f35916a9155600_candidate is not item for item in _ember_35f35916a9155600_existing):
        _ember_35f35916a9155600_existing.append(_ember_35f35916a9155600_candidate)
if len(_ember_35f35916a9155600_existing) > 1:
    raise ImportError('EXACT_LOCAL_IMPORT_IDENTITY_COLLISION:src/ember/infrastructure/tools/ember-restart-3b/optimizer_transition.py')
if _ember_35f35916a9155600_existing:
    _ember_35f35916a9155600_module = _ember_35f35916a9155600_existing[0]
    _ember_35f35916a9155600_observed = getattr(_ember_35f35916a9155600_module, '__file__', None)
    if _ember_35f35916a9155600_observed is None or _ember_35f35916a9155600_Path(_ember_35f35916a9155600_observed).resolve() != _ember_35f35916a9155600_path:
        raise ImportError('EXACT_LOCAL_IMPORT_WRONG_TARGET:src/ember/infrastructure/tools/ember-restart-3b/optimizer_transition.py')
else:
    _ember_35f35916a9155600_spec = _ember_35f35916a9155600_importlib.spec_from_file_location('_ember_issue2015_35f35916a9155600', _ember_35f35916a9155600_path)
    if _ember_35f35916a9155600_spec is None or _ember_35f35916a9155600_spec.loader is None:
        raise ImportError('EXACT_LOCAL_IMPORT_SPEC_INVALID:src/ember/infrastructure/tools/ember-restart-3b/optimizer_transition.py')
    _ember_35f35916a9155600_module = _ember_35f35916a9155600_importlib.module_from_spec(_ember_35f35916a9155600_spec)
    for _ember_35f35916a9155600_alias in _ember_35f35916a9155600_aliases:
        _ember_35f35916a9155600_prior = _ember_35f35916a9155600_sys.modules.get(_ember_35f35916a9155600_alias)
        if _ember_35f35916a9155600_prior is not None and _ember_35f35916a9155600_prior is not _ember_35f35916a9155600_module:
            raise ImportError('EXACT_LOCAL_IMPORT_ALIAS_COLLISION:src/ember/infrastructure/tools/ember-restart-3b/optimizer_transition.py')
        _ember_35f35916a9155600_sys.modules[_ember_35f35916a9155600_alias] = _ember_35f35916a9155600_module
    try:
        _ember_35f35916a9155600_spec.loader.exec_module(_ember_35f35916a9155600_module)
    except BaseException:
        for _ember_35f35916a9155600_alias in _ember_35f35916a9155600_aliases:
            if _ember_35f35916a9155600_sys.modules.get(_ember_35f35916a9155600_alias) is _ember_35f35916a9155600_module:
                _ember_35f35916a9155600_sys.modules.pop(_ember_35f35916a9155600_alias, None)
        raise
for _ember_35f35916a9155600_alias in _ember_35f35916a9155600_aliases:
    _ember_35f35916a9155600_prior = _ember_35f35916a9155600_sys.modules.get(_ember_35f35916a9155600_alias)
    if _ember_35f35916a9155600_prior is not None and _ember_35f35916a9155600_prior is not _ember_35f35916a9155600_module:
        raise ImportError('EXACT_LOCAL_IMPORT_ALIAS_COLLISION:src/ember/infrastructure/tools/ember-restart-3b/optimizer_transition.py')
    _ember_35f35916a9155600_sys.modules[_ember_35f35916a9155600_alias] = _ember_35f35916a9155600_module
validate_optimizer_transition_registry = getattr(_ember_35f35916a9155600_module, 'validate_optimizer_transition_registry')
# issue2015 exact-local-import-end:src/ember/infrastructure/tools/ember-restart-3b/optimizer_transition.py
# issue2015 exact-local-import:src/ember/infrastructure/tools/ember-restart-3b/step2_realization_registry.py
import importlib.util as _ember_5f50765f1675ddc7_importlib
import sys as _ember_5f50765f1675ddc7_sys
from pathlib import Path as _ember_5f50765f1675ddc7_Path
_ember_5f50765f1675ddc7_path = _ember_5f50765f1675ddc7_Path(__file__).resolve().parents[2].joinpath('src', 'ember', 'infrastructure', 'tools', 'ember-restart-3b', 'step2_realization_registry.py')
if not _ember_5f50765f1675ddc7_path.is_file():
    raise ImportError('EXACT_LOCAL_IMPORT_TARGET_MISSING:src/ember/infrastructure/tools/ember-restart-3b/step2_realization_registry.py')
_ember_5f50765f1675ddc7_aliases = ('_ember_issue2015_5f50765f1675ddc7', 'step2_realization_registry', 'tools.ember-restart-3b.step2_realization_registry')
_ember_5f50765f1675ddc7_existing = []
for _ember_5f50765f1675ddc7_alias in _ember_5f50765f1675ddc7_aliases:
    _ember_5f50765f1675ddc7_candidate = _ember_5f50765f1675ddc7_sys.modules.get(_ember_5f50765f1675ddc7_alias)
    if _ember_5f50765f1675ddc7_candidate is not None and all(_ember_5f50765f1675ddc7_candidate is not item for item in _ember_5f50765f1675ddc7_existing):
        _ember_5f50765f1675ddc7_existing.append(_ember_5f50765f1675ddc7_candidate)
if len(_ember_5f50765f1675ddc7_existing) > 1:
    raise ImportError('EXACT_LOCAL_IMPORT_IDENTITY_COLLISION:src/ember/infrastructure/tools/ember-restart-3b/step2_realization_registry.py')
if _ember_5f50765f1675ddc7_existing:
    _ember_5f50765f1675ddc7_module = _ember_5f50765f1675ddc7_existing[0]
    _ember_5f50765f1675ddc7_observed = getattr(_ember_5f50765f1675ddc7_module, '__file__', None)
    if _ember_5f50765f1675ddc7_observed is None or _ember_5f50765f1675ddc7_Path(_ember_5f50765f1675ddc7_observed).resolve() != _ember_5f50765f1675ddc7_path:
        raise ImportError('EXACT_LOCAL_IMPORT_WRONG_TARGET:src/ember/infrastructure/tools/ember-restart-3b/step2_realization_registry.py')
else:
    _ember_5f50765f1675ddc7_spec = _ember_5f50765f1675ddc7_importlib.spec_from_file_location('_ember_issue2015_5f50765f1675ddc7', _ember_5f50765f1675ddc7_path)
    if _ember_5f50765f1675ddc7_spec is None or _ember_5f50765f1675ddc7_spec.loader is None:
        raise ImportError('EXACT_LOCAL_IMPORT_SPEC_INVALID:src/ember/infrastructure/tools/ember-restart-3b/step2_realization_registry.py')
    _ember_5f50765f1675ddc7_module = _ember_5f50765f1675ddc7_importlib.module_from_spec(_ember_5f50765f1675ddc7_spec)
    for _ember_5f50765f1675ddc7_alias in _ember_5f50765f1675ddc7_aliases:
        _ember_5f50765f1675ddc7_prior = _ember_5f50765f1675ddc7_sys.modules.get(_ember_5f50765f1675ddc7_alias)
        if _ember_5f50765f1675ddc7_prior is not None and _ember_5f50765f1675ddc7_prior is not _ember_5f50765f1675ddc7_module:
            raise ImportError('EXACT_LOCAL_IMPORT_ALIAS_COLLISION:src/ember/infrastructure/tools/ember-restart-3b/step2_realization_registry.py')
        _ember_5f50765f1675ddc7_sys.modules[_ember_5f50765f1675ddc7_alias] = _ember_5f50765f1675ddc7_module
    try:
        _ember_5f50765f1675ddc7_spec.loader.exec_module(_ember_5f50765f1675ddc7_module)
    except BaseException:
        for _ember_5f50765f1675ddc7_alias in _ember_5f50765f1675ddc7_aliases:
            if _ember_5f50765f1675ddc7_sys.modules.get(_ember_5f50765f1675ddc7_alias) is _ember_5f50765f1675ddc7_module:
                _ember_5f50765f1675ddc7_sys.modules.pop(_ember_5f50765f1675ddc7_alias, None)
        raise
for _ember_5f50765f1675ddc7_alias in _ember_5f50765f1675ddc7_aliases:
    _ember_5f50765f1675ddc7_prior = _ember_5f50765f1675ddc7_sys.modules.get(_ember_5f50765f1675ddc7_alias)
    if _ember_5f50765f1675ddc7_prior is not None and _ember_5f50765f1675ddc7_prior is not _ember_5f50765f1675ddc7_module:
        raise ImportError('EXACT_LOCAL_IMPORT_ALIAS_COLLISION:src/ember/infrastructure/tools/ember-restart-3b/step2_realization_registry.py')
    _ember_5f50765f1675ddc7_sys.modules[_ember_5f50765f1675ddc7_alias] = _ember_5f50765f1675ddc7_module
validate_step2_realization_registry_bundle = getattr(_ember_5f50765f1675ddc7_module, 'validate_step2_realization_registry_bundle')
# issue2015 exact-local-import-end:src/ember/infrastructure/tools/ember-restart-3b/step2_realization_registry.py
# issue2015 exact-local-import:src/ember/infrastructure/tools/ember-restart-3b/train.py
import importlib.util as _ember_f216cdc78c9d2d43_importlib
import sys as _ember_f216cdc78c9d2d43_sys
from pathlib import Path as _ember_f216cdc78c9d2d43_Path
_ember_f216cdc78c9d2d43_path = _ember_f216cdc78c9d2d43_Path(__file__).resolve().parents[2].joinpath('src', 'ember', 'infrastructure', 'tools', 'ember-restart-3b', 'train.py')
if not _ember_f216cdc78c9d2d43_path.is_file():
    raise ImportError('EXACT_LOCAL_IMPORT_TARGET_MISSING:src/ember/infrastructure/tools/ember-restart-3b/train.py')
_ember_f216cdc78c9d2d43_aliases = ('_ember_issue2015_f216cdc78c9d2d43', 'tools.ember-restart-3b.train', 'train')
_ember_f216cdc78c9d2d43_existing = []
for _ember_f216cdc78c9d2d43_alias in _ember_f216cdc78c9d2d43_aliases:
    _ember_f216cdc78c9d2d43_candidate = _ember_f216cdc78c9d2d43_sys.modules.get(_ember_f216cdc78c9d2d43_alias)
    if _ember_f216cdc78c9d2d43_candidate is not None and all(_ember_f216cdc78c9d2d43_candidate is not item for item in _ember_f216cdc78c9d2d43_existing):
        _ember_f216cdc78c9d2d43_existing.append(_ember_f216cdc78c9d2d43_candidate)
if len(_ember_f216cdc78c9d2d43_existing) > 1:
    raise ImportError('EXACT_LOCAL_IMPORT_IDENTITY_COLLISION:src/ember/infrastructure/tools/ember-restart-3b/train.py')
if _ember_f216cdc78c9d2d43_existing:
    _ember_f216cdc78c9d2d43_module = _ember_f216cdc78c9d2d43_existing[0]
    _ember_f216cdc78c9d2d43_observed = getattr(_ember_f216cdc78c9d2d43_module, '__file__', None)
    if _ember_f216cdc78c9d2d43_observed is None or _ember_f216cdc78c9d2d43_Path(_ember_f216cdc78c9d2d43_observed).resolve() != _ember_f216cdc78c9d2d43_path:
        raise ImportError('EXACT_LOCAL_IMPORT_WRONG_TARGET:src/ember/infrastructure/tools/ember-restart-3b/train.py')
else:
    _ember_f216cdc78c9d2d43_spec = _ember_f216cdc78c9d2d43_importlib.spec_from_file_location('_ember_issue2015_f216cdc78c9d2d43', _ember_f216cdc78c9d2d43_path)
    if _ember_f216cdc78c9d2d43_spec is None or _ember_f216cdc78c9d2d43_spec.loader is None:
        raise ImportError('EXACT_LOCAL_IMPORT_SPEC_INVALID:src/ember/infrastructure/tools/ember-restart-3b/train.py')
    _ember_f216cdc78c9d2d43_module = _ember_f216cdc78c9d2d43_importlib.module_from_spec(_ember_f216cdc78c9d2d43_spec)
    for _ember_f216cdc78c9d2d43_alias in _ember_f216cdc78c9d2d43_aliases:
        _ember_f216cdc78c9d2d43_prior = _ember_f216cdc78c9d2d43_sys.modules.get(_ember_f216cdc78c9d2d43_alias)
        if _ember_f216cdc78c9d2d43_prior is not None and _ember_f216cdc78c9d2d43_prior is not _ember_f216cdc78c9d2d43_module:
            raise ImportError('EXACT_LOCAL_IMPORT_ALIAS_COLLISION:src/ember/infrastructure/tools/ember-restart-3b/train.py')
        _ember_f216cdc78c9d2d43_sys.modules[_ember_f216cdc78c9d2d43_alias] = _ember_f216cdc78c9d2d43_module
    try:
        _ember_f216cdc78c9d2d43_spec.loader.exec_module(_ember_f216cdc78c9d2d43_module)
    except BaseException:
        for _ember_f216cdc78c9d2d43_alias in _ember_f216cdc78c9d2d43_aliases:
            if _ember_f216cdc78c9d2d43_sys.modules.get(_ember_f216cdc78c9d2d43_alias) is _ember_f216cdc78c9d2d43_module:
                _ember_f216cdc78c9d2d43_sys.modules.pop(_ember_f216cdc78c9d2d43_alias, None)
        raise
for _ember_f216cdc78c9d2d43_alias in _ember_f216cdc78c9d2d43_aliases:
    _ember_f216cdc78c9d2d43_prior = _ember_f216cdc78c9d2d43_sys.modules.get(_ember_f216cdc78c9d2d43_alias)
    if _ember_f216cdc78c9d2d43_prior is not None and _ember_f216cdc78c9d2d43_prior is not _ember_f216cdc78c9d2d43_module:
        raise ImportError('EXACT_LOCAL_IMPORT_ALIAS_COLLISION:src/ember/infrastructure/tools/ember-restart-3b/train.py')
    _ember_f216cdc78c9d2d43_sys.modules[_ember_f216cdc78c9d2d43_alias] = _ember_f216cdc78c9d2d43_module
run_launch = getattr(_ember_f216cdc78c9d2d43_module, 'run_launch')
run_text_lab_preflight = getattr(_ember_f216cdc78c9d2d43_module, 'run_text_lab_preflight')
# issue2015 exact-local-import-end:src/ember/infrastructure/tools/ember-restart-3b/train.py
...
# issue2015 exact-local-import-end:src/ember/infrastructure/tools/ember-restart-3b/a1_dense.py
# issue2015 exact-local-import:src/ember/infrastructure/tools/ember-restart-3b/a1_tier2_contract.py
import importlib.util as _ember_24be29e78b31e759_importlib
import sys as _ember_24be29e78b31e759_sys
from pathlib import Path as _ember_24be29e78b31e759_Path
_ember_24be29e78b31e759_path = _ember_24be29e78b31e759_Path(__file__).resolve().parents[2].joinpath('src', 'ember', 'infrastructure', 'tools', 'ember-restart-3b', 'a1_tier2_contract.py')
if not _ember_24be29e78b31e759_path.is_file():
    raise ImportError('EXACT_LOCAL_IMPORT_TARGET_MISSING:src/ember/infrastructure/tools/ember-restart-3b/a1_tier2_contract.py')
_ember_24be29e78b31e759_aliases = ('_ember_issue2015_24be29e78b31e759', 'a1_tier2_contract', 'tools.ember-restart-3b.a1_tier2_contract')
_ember_24be29e78b31e759_existing = []
for _ember_24be29e78b31e759_alias in _ember_24be29e78b31e759_aliases:
    _ember_24be29e78b31e759_candidate = _ember_24be29e78b31e759_sys.modules.get(_ember_24be29e78b31e759_alias)
    if _ember_24be29e78b31e759_candidate is not None and all(_ember_24be29e78b31e759_candidate is not item for item in _ember_24be29e78b31e759_existing):
        _ember_24be29e78b31e759_existing.append(_ember_24be29e78b31e759_candidate)
if len(_ember_24be29e78b31e759_existing) > 1:
    raise ImportError('EXACT_LOCAL_IMPORT_IDENTITY_COLLISION:src/ember/infrastructure/tools/ember-restart-3b/a1_tier2_contract.py')
if _ember_24be29e78b31e759_existing:
    _ember_24be29e78b31e759_module = _ember_24be29e78b31e759_existing[0]
    _ember_24be29e78b31e759_observed = getattr(_ember_24be29e78b31e759_module, '__file__', None)
    if _ember_24be29e78b31e759_observed is None or _ember_24be29e78b31e759_Path(_ember_24be29e78b31e759_observed).resolve() != _ember_24be29e78b31e759_path:
        raise ImportError('EXACT_LOCAL_IMPORT_WRONG_TARGET:src/ember/infrastructure/tools/ember-restart-3b/a1_tier2_contract.py')
else:
    _ember_24be29e78b31e759_spec = _ember_24be29e78b31e759_importlib.spec_from_file_location('_ember_issue2015_24be29e78b31e759', _ember_24be29e78b31e759_path)
    if _ember_24be29e78b31e759_spec is None or _ember_24be29e78b31e759_spec.loader is None:
        raise ImportError('EXACT_LOCAL_IMPORT_SPEC_INVALID:src/ember/infrastructure/tools/ember-restart-3b/a1_tier2_contract.py')
    _ember_24be29e78b31e759_module = _ember_24be29e78b31e759_importlib.module_from_spec(_ember_24be29e78b31e759_spec)
    for _ember_24be29e78b31e759_alias in _ember_24be29e78b31e759_aliases:
        _ember_24be29e78b31e759_prior = _ember_24be29e78b31e759_sys.modules.get(_ember_24be29e78b31e759_alias)
        if _ember_24be29e78b31e759_prior is not None and _ember_24be29e78b31e759_prior is not _ember_24be29e78b31e759_module:
            raise ImportError('EXACT_LOCAL_IMPORT_ALIAS_COLLISION:src/ember/infrastructure/tools/ember-restart-3b/a1_tier2_contract.py')
        _ember_24be29e78b31e759_sys.modules[_ember_24be29e78b31e759_alias] = _ember_24be29e78b31e759_module
    try:
        _ember_24be29e78b31e759_spec.loader.exec_module(_ember_24be29e78b31e759_module)
    except BaseException:
        for _ember_24be29e78b31e759_alias in _ember_24be29e78b31e759_aliases:
            if _ember_24be29e78b31e759_sys.modules.get(_ember_24be29e78b31e759_alias) is _ember_24be29e78b31e759_module:
                _ember_24be29e78b31e759_sys.modules.pop(_ember_24be29e78b31e759_alias, None)
        raise
for _ember_24be29e78b31e759_alias in _ember_24be29e78b31e759_aliases:
    _ember_24be29e78b31e759_prior = _ember_24be29e78b31e759_sys.modules.get(_ember_24be29e78b31e759_alias)
    if _ember_24be29e78b31e759_prior is not None and _ember_24be29e78b31e759_prior is not _ember_24be29e78b31e759_module:
        raise ImportError('EXACT_LOCAL_IMPORT_ALIAS_COLLISION:src/ember/infrastructure/tools/ember-restart-3b/a1_tier2_contract.py')
    _ember_24be29e78b31e759_sys.modules[_ember_24be29e78b31e759_alias] = _ember_24be29e78b31e759_module
admit_tier2_resources = getattr(_ember_24be29e78b31e759_module, 'admit_tier2_resources')
derive_tier2_resource_inventory = getattr(_ember_24be29e78b31e759_module, 'derive_tier2_resource_inventory')
load_tier2_contract = getattr(_ember_24be29e78b31e759_module, 'load_tier2_contract')
# issue2015 exact-local-import-end:src/ember/infrastructure/tools/ember-restart-3b/a1_tier2_contract.py
# issue2015 exact-local-import:src/ember/infrastructure/tools/ember-restart-3b/a1_tier2_execution.py
import importlib.util as _ember_f733b674b04175d9_importlib
import sys as _ember_f733b674b04175d9_sys
from pathlib import Path as _ember_f733b674b04175d9_Path
_ember_f733b674b04175d9_path = _ember_f733b674b04175d9_Path(__file__).resolve().parents[2].joinpath('src', 'ember', 'infrastructure', 'tools', 'ember-restart-3b', 'a1_tier2_execution.py')
if not _ember_f733b674b04175d9_path.is_file():
    raise ImportError('EXACT_LOCAL_IMPORT_TARGET_MISSING:src/ember/infrastructure/tools/ember-restart-3b/a1_tier2_execution.py')
_ember_f733b674b04175d9_aliases = ('_ember_issue2015_f733b674b04175d9', 'a1_tier2_execution', 'tools.ember-restart-3b.a1_tier2_execution')
_ember_f733b674b04175d9_existing = []
for _ember_f733b674b04175d9_alias in _ember_f733b674b04175d9_aliases:
    _ember_f733b674b04175d9_candidate = _ember_f733b674b04175d9_sys.modules.get(_ember_f733b674b04175d9_alias)
    if _ember_f733b674b04175d9_candidate is not None and all(_ember_f733b674b04175d9_candidate is not item for item in _ember_f733b674b04175d9_existing):
        _ember_f733b674b04175d9_existing.append(_ember_f733b674b04175d9_candidate)
if len(_ember_f733b674b04175d9_existing) > 1:
    raise ImportError('EXACT_LOCAL_IMPORT_IDENTITY_COLLISION:src/ember/infrastructure/tools/ember-restart-3b/a1_tier2_execution.py')
if _ember_f733b674b04175d9_existing:
    _ember_f733b674b04175d9_module = _ember_f733b674b04175d9_existing[0]
    _ember_f733b674b04175d9_observed = getattr(_ember_f733b674b04175d9_module, '__file__', None)
    if _ember_f733b674b04175d9_observed is None or _ember_f733b674b04175d9_Path(_ember_f733b674b04175d9_observed).resolve() != _ember_f733b674b04175d9_path:
        raise ImportError('EXACT_LOCAL_IMPORT_WRONG_TARGET:src/ember/infrastructure/tools/ember-restart-3b/a1_tier2_execution.py')
else:
    _ember_f733b674b04175d9_spec = _ember_f733b674b04175d9_importlib.spec_from_file_location('_ember_issue2015_f733b674b04175d9', _ember_f733b674b04175d9_path)
    if _ember_f733b674b04175d9_spec is None or _ember_f733b674b04175d9_spec.loader is None:
        raise ImportError('EXACT_LOCAL_IMPORT_SPEC_INVALID:src/ember/infrastructure/tools/ember-restart-3b/a1_tier2_execution.py')
    _ember_f733b674b04175d9_module = _ember_f733b674b04175d9_importlib.module_from_spec(_ember_f733b674b04175d9_spec)
    for _ember_f733b674b04175d9_alias in _ember_f733b674b04175d9_aliases:
        _ember_f733b674b04175d9_prior = _ember_f733b674b04175d9_sys.modules.get(_ember_f733b674b04175d9_alias)
        if _ember_f733b674b04175d9_prior is not None and _ember_f733b674b04175d9_prior is not _ember_f733b674b04175d9_module:
            raise ImportError('EXACT_LOCAL_IMPORT_ALIAS_COLLISION:src/ember/infrastructure/tools/ember-restart-3b/a1_tier2_execution.py')
        _ember_f733b674b04175d9_sys.modules[_ember_f733b674b04175d9_alias] = _ember_f733b674b04175d9_module
    try:
        _ember_f733b674b04175d9_spec.loader.exec_module(_ember_f733b674b04175d9_module)
    except BaseException:
        for _ember_f733b674b04175d9_alias in _ember_f733b674b04175d9_aliases:
            if _ember_f733b674b04175d9_sys.modules.get(_ember_f733b674b04175d9_alias) is _ember_f733b674b04175d9_module:
                _ember_f733b674b04175d9_sys.modules.pop(_ember_f733b674b04175d9_alias, None)
        raise
for _ember_f733b674b04175d9_alias in _ember_f733b674b04175d9_aliases:
    _ember_f733b674b04175d9_prior = _ember_f733b674b04175d9_sys.modules.get(_ember_f733b674b04175d9_alias)
    if _ember_f733b674b04175d9_prior is not None and _ember_f733b674b04175d9_prior is not _ember_f733b674b04175d9_module:
        raise ImportError('EXACT_LOCAL_IMPORT_ALIAS_COLLISION:src/ember/infrastructure/tools/ember-restart-3b/a1_tier2_execution.py')
    _ember_f733b674b04175d9_sys.modules[_ember_f733b674b04175d9_alias] = _ember_f733b674b04175d9_module
run_dense_a1_tier2 = getattr(_ember_f733b674b04175d9_module, 'run_dense_a1_tier2')
# issue2015 exact-local-import-end:src/ember/infrastructure/tools/ember-restart-3b/a1_tier2_execution.py
