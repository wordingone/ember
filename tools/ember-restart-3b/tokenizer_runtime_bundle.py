...
# disposition: ADAPTER
# issue1949 old_path: tools/ember-restart-3b/tokenizer_runtime_bundle.py
# issue1949 new_path: src/ember/infrastructure/tools/ember-restart-3b/tokenizer_runtime_bundle.py
...
_issue1949_target = _issue1949_root.joinpath('src', 'ember', 'infrastructure', 'tools', 'ember-restart-3b', 'tokenizer_runtime_bundle.py')
if not _issue1949_target.is_file():
    raise ImportError("ISSUE1949_ADAPTER_TARGET_MISSING:src/ember/infrastructure/tools/ember-restart-3b/tokenizer_runtime_bundle.py")
_issue1949_name = "_ember_issue1949_4b0514041c2271ff"
...
if _issue1949_spec is None or _issue1949_spec.loader is None:
    raise ImportError("ISSUE1949_ADAPTER_SPEC_INVALID:src/ember/infrastructure/tools/ember-restart-3b/tokenizer_runtime_bundle.py")
