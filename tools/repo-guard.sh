...
# Matches private local drive roots, local user homes, downloads, and mount paths.
...
case "$BR" in
  ...
  *) fail "branch" "branch '$BR' must match <type>/<slug> where type in feat|fix|exp|chore|docs, or codex/* for short-lived staging" ;;
esac
